...
page_title: "elestio_leantime Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Leantime is a strategic project management system for non-project managers.The elestio_leantime resource allows the creation and management of Elestio Leantime services. The service uses the following docker image elestio/leantime https://hub.docker.com/r/elestio/leantime
---

# elestio_leantime (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Leantime-NW3G.webp" width="100" /><br>Leantime is a strategic project management system for non-project managers.<br><br>The **elestio_leantime** resource allows the creation and management of Elestio Leantime services. The service uses the following docker image [elestio/leantime](https://hub.docker.com/r/elestio/leantime)
...
```shell
# Import a Leantime service by specifying the Project ID it belongs to, and the Leantime service ID (spaced by a comma).
terraform import elestio_leantime.my_leantime project_id,leantime_service_id
```
