...
<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/1554232612738-debianlogo.png" width="100" height="100" /><br/> Debian is a resource that creates a service with the `template_id = 36`. Debian (aka Debian GNU/Linux) is a Linux distribution composed of free and open-source software.
