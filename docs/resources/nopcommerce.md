...
subcategory: ""
description: |-
  nopCommerce Resource is a preconfigured Service Resource with the template_id = 217. nopCommerce is the most popular ASP.NET shopping cart in the world based on Microsoft technologies. Free and open-source eCommerce platform. Docker hub image: nopcommerceteam/nopcommerce https://hub.docker.com/r/nopcommerceteam/nopcommerce
---

# elestio_nopcommerce (Resource)

nopCommerce Resource is a preconfigured Service Resource with the `template_id = 217`.<br/><br/><img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nopcommerce-NcUG.svg" width="100" height="100" /><br/> nopCommerce is the most popular ASP.NET shopping cart in the world based on Microsoft technologies. Free and open-source eCommerce platform.<br/><br/> Docker hub image: [`nopcommerceteam/nopcommerce`](https://hub.docker.com/r/nopcommerceteam/nopcommerce)
