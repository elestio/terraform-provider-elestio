...
description: |-
  Appsmith is a powerful open-source framework to build internal tools. The elestio_appsmith resource allows the creation and management of Elestio Appsmith services. The service uses the following docker image appsmith/appsmith-ce https://hub.docker.com/r/appsmith/appsmith-ce
---
