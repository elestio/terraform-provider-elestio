...
description: |-
  WordPress is open-source software you can use to create a beautiful website, blog or app.The elestio_wordpress resource allows the creation and management of Elestio Wordpress services. The service uses the following docker image wordpress https://hub.docker.com/r/wordpress
---
