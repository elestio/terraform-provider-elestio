...
description: |-
  LanguageTool is an Open Source proofreading software for English, Spanish, French, German, Portuguese, Polish, Dutch, and more than 20 other languages.The elestio_languagetool resource allows the creation and management of Elestio LanguageTool services. The service uses the following docker image elestio/languagetool https://hub.docker.com/r/elestio/languagetool
---
