...
page_title: "elestio_langfuse Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open source LLM engineering platform: LLM Observability, metrics, evaluations, prompt management, playground, datasets. Integrates with LlamaIndex, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23The elestio_langfuse resource allows the creation and management of Elestio Langfuse services. The service uses the following docker image langfuse/langfuse https://hub.docker.com/r/langfuse/langfuse
---

# elestio_langfuse (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Langfuse-3D1r.png" width="100" /><br>Open source LLM engineering platform: LLM Observability, metrics, evaluations, prompt management, playground, datasets. Integrates with LlamaIndex, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23<br><br>The **elestio_langfuse** resource allows the creation and management of Elestio Langfuse services. The service uses the following docker image [langfuse/langfuse](https://hub.docker.com/r/langfuse/langfuse)
...
```shell
# Import a Langfuse service by specifying the Project ID it belongs to, and the Langfuse service ID (spaced by a comma).
terraform import elestio_langfuse.my_langfuse project_id,langfuse_service_id
```
