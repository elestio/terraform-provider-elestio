...
description: |-
  Invoice Ninja is the leading free, open-source online invoicing app for freelancers and businesses. The elestio_invoiceninja resource allows the creation and management of Elestio InvoiceNinja services. The service uses the following docker image invoiceninja/invoiceninja https://hub.docker.com/r/invoiceninja/invoiceninja
---
