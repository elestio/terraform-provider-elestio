...
page_title: "elestio_corteza Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A low-code platform alternative to Salesforce lets you build and iterate CRM, business processes and other structured data apps fast, create intelligent business process workflows, and connect with almost any data source. The elestio_corteza resource allows the creation and management of Elestio Corteza services. The service uses the following docker image cortezaproject/corteza https://hub.docker.com/r/cortezaproject/corteza
---

# elestio_corteza (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Corteza-mZtp.png" width="100" /><br>A low-code platform alternative to Salesforce lets you build and iterate CRM, business processes and other structured data apps fast, create intelligent business process workflows, and connect with almost any data source. <br><br>The **elestio_corteza** resource allows the creation and management of Elestio Corteza services. The service uses the following docker image [cortezaproject/corteza](https://hub.docker.com/r/cortezaproject/corteza)
...
- `version` (String) This is the version of the software used as service. **Default** `2024.9.0-rc.5`.
...
```shell
# Import a Corteza service by specifying the Project ID it belongs to, and the Corteza service ID (spaced by a comma).
terraform import elestio_corteza.my_corteza project_id,corteza_service_id
```
