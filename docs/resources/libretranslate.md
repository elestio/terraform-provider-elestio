...
page_title: "elestio_libretranslate Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Free and Open Source Machine Translation API. The elestio_libretranslate resource allows the creation and management of Elestio LibreTranslate services. The service uses the following docker image libretranslate/libretranslate https://hub.docker.com/r/libretranslate/libretranslate
---

# elestio_libretranslate (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/LibreTranslate-ILTi.png" width="100" /><br>Free and Open Source Machine Translation API. <br><br>The **elestio_libretranslate** resource allows the creation and management of Elestio LibreTranslate services. The service uses the following docker image [libretranslate/libretranslate](https://hub.docker.com/r/libretranslate/libretranslate)
...
```shell
# Import a LibreTranslate service by specifying the Project ID it belongs to, and the LibreTranslate service ID (spaced by a comma).
terraform import elestio_libretranslate.my_libretranslate project_id,libretranslate_service_id
```
