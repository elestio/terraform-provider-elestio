...
page_title: "elestio_cryptgeon Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Cryptgeon is a secure, open-source note / file-sharing service inspired by PrivNote written in rust & svelte.The elestio_cryptgeon resource allows the creation and management of Elestio Cryptgeon services. The service uses the following docker image elestio/cryptgeon https://hub.docker.com/r/elestio/cryptgeon
---

# elestio_cryptgeon (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Cryptgeon-g7dQ.png" width="100" /><br>Cryptgeon is a secure, open-source note / file-sharing service inspired by PrivNote written in rust & svelte.<br><br>The **elestio_cryptgeon** resource allows the creation and management of Elestio Cryptgeon services. The service uses the following docker image [elestio/cryptgeon](https://hub.docker.com/r/elestio/cryptgeon)
...
```shell
# Import a Cryptgeon service by specifying the Project ID it belongs to, and the Cryptgeon service ID (spaced by a comma).
terraform import elestio_cryptgeon.my_cryptgeon project_id,cryptgeon_service_id
```
