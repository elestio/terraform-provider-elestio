...
page_title: "elestio_emqx Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  MQTT broker for IoT, IIoT, and connected vehicles. it supports multiple open standard protocols like MQTT, HTTP, QUIC, and WebSocket.The elestio_emqx resource allows the creation and management of Elestio EMQX services. The service uses the following docker image emqx/emqx https://hub.docker.com/r/emqx/emqx
---

# elestio_emqx (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/EMQX-7FSs.png" width="100" /><br>MQTT broker for IoT, IIoT, and connected vehicles. it supports multiple open standard protocols like MQTT, HTTP, QUIC, and WebSocket.<br><br>The **elestio_emqx** resource allows the creation and management of Elestio EMQX services. The service uses the following docker image [emqx/emqx](https://hub.docker.com/r/emqx/emqx)
...
- `version` (String) This is the version of the software used as service. **Default** `5.5.1`.
...
```shell
# Import a EMQX service by specifying the Project ID it belongs to, and the EMQX service ID (spaced by a comma).
terraform import elestio_emqx.my_emqx project_id,emqx_service_id
```
