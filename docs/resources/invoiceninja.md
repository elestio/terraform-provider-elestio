...
subcategory: ""
description: |-
  Invoice Ninja is the leading free, open-source online invoicing app for freelancers and businesses. elestio_invoiceninja is a preconfigured elestio_service resource (template_id: 152) running InvoiceNinja from the Docker image https://hub.docker.com/r/invoiceninja/invoiceninja invoiceninja/invoiceninja.
---

# elestio_invoiceninja (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/InvoiceNinja-logo-220x90-J8W0.png" width="100" /><br/> Invoice Ninja is the leading free, open-source online invoicing app for freelancers and businesses. <br/><br/>**elestio_invoiceninja** is a preconfigured elestio_service resource (`template_id: 152`) running **InvoiceNinja** from the [Docker image](https://hub.docker.com/r/invoiceninja/invoiceninja) `invoiceninja/invoiceninja`.
...
```shell
# Import a InvoiceNinja service by specifying the Project ID it belongs to, and the InvoiceNinja service ID (spaced by a comma).
terraform import elestio_invoiceninja.my_invoiceninja project_id,invoiceninja_service_id
```
