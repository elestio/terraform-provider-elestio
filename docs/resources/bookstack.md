...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/bookstack--1--KwEn.png" width="100" height="100" /><br/> BookStack is a resource that creates a service with the `template_id = 143`. BookStack is a platform to create documentation/wiki content built with PHP & Laravel.
