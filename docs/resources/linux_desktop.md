...
subcategory: ""
description: |-
  elestiolinuxdesktop is a preconfigured elestio_service resource (template_id: 236) running Linux-desktop.
---

# elestio_linux_desktop (Resource)

**elestio_linux_desktop** is a preconfigured elestio_service resource (`template_id: 236`) running **Linux-desktop**.
