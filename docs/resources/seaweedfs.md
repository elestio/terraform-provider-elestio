...
page_title: "elestio_seaweedfs Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  SeaweedFS is a distributed storage system for object storage (S3), file systems, and Iceberg tables, designed to handle billions of files with O(1) disk access and effortless horizontal scaling.The elestio_seaweedfs resource allows the creation and management of Elestio SeaweedFS services. The service uses the following docker image chrislusf/seaweedfs https://hub.docker.com/r/chrislusf/seaweedfs
---

# elestio_seaweedfs (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/SeaweedFS-UHzj.png" width="100" /><br>SeaweedFS is a distributed storage system for object storage (S3), file systems, and Iceberg tables, designed to handle billions of files with O(1) disk access and effortless horizontal scaling.<br><br>The **elestio_seaweedfs** resource allows the creation and management of Elestio SeaweedFS services. The service uses the following docker image [chrislusf/seaweedfs](https://hub.docker.com/r/chrislusf/seaweedfs)
...
```shell
# Import a SeaweedFS service by specifying the Project ID it belongs to, and the SeaweedFS service ID (spaced by a comma).
terraform import elestio_seaweedfs.my_seaweedfs project_id,seaweedfs_service_id
```
