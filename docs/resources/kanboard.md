...
page_title: "elestio_kanboard Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Kanban project management softwareThe elestio_kanboard resource allows the creation and management of Elestio Kanboard services. The service uses the following docker image kanboard/kanboard https://hub.docker.com/r/kanboard/kanboard
---

# elestio_kanboard (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Kanboard-TAr7.png" width="100" /><br>Kanban project management software<br><br>The **elestio_kanboard** resource allows the creation and management of Elestio Kanboard services. The service uses the following docker image [kanboard/kanboard](https://hub.docker.com/r/kanboard/kanboard)
...
```shell
# Import a Kanboard service by specifying the Project ID it belongs to, and the Kanboard service ID (spaced by a comma).
terraform import elestio_kanboard.my_kanboard project_id,kanboard_service_id
```
