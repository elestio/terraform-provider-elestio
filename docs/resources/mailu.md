...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/mailu-logo-W4op.png" width="100" height="100" /><br/> Mailu is a resource that creates a service with the `template_id = 189`. Mailu is an insular email distribution - mail server as Docker images
