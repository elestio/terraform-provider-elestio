...
page_title: "elestio_mirotalk Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  WebRTC - P2P - Simple, Secure, Fast Real-Time Video Conferences Up to 4k and 60fps, compatible with all browsers and platforms.The elestio_mirotalk resource allows the creation and management of Elestio MiroTalk services. The service uses the following docker image elestio/mirotalk https://hub.docker.com/r/elestio/mirotalk
---
...
```shell
# Import a MiroTalk service by specifying the Project ID it belongs to, and the MiroTalk service ID (spaced by a comma).
terraform import elestio_mirotalk.my_mirotalk project_id,mirotalk_service_id
```
