...
page_title: "elestio_temporal Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Temporal is a durable execution platform that enables developers to build scalable applications without sacrificing productivity or reliabilityThe elestio_temporal resource allows the creation and management of Elestio Temporal services. The service uses the following docker image temporalio/auto-setup https://hub.docker.com/r/temporalio/auto-setup
---

# elestio_temporal (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Temporal-Jhsc.png" width="100" /><br>Temporal is a durable execution platform that enables developers to build scalable applications without sacrificing productivity or reliability<br><br>The **elestio_temporal** resource allows the creation and management of Elestio Temporal services. The service uses the following docker image [temporalio/auto-setup](https://hub.docker.com/r/temporalio/auto-setup)
...
- `version` (String) This is the version of the software used as service. **Default** `1.27.2`.
...
```shell
# Import a Temporal service by specifying the Project ID it belongs to, and the Temporal service ID (spaced by a comma).
terraform import elestio_temporal.my_temporal project_id,temporal_service_id
```
