...
description: |-
  OnlyOffice is an online office suite that includes editors and viewers for text documents, spreadsheets, and presentations.The elestio_onlyoffice resource allows the creation and management of Elestio OnlyOffice services. The service uses the following docker image onlyoffice/communityserver https://hub.docker.com/r/onlyoffice/communityserver
---

# elestio_onlyoffice (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/onlyoffice-BiCl.png" width="100" /><br>OnlyOffice is an online office suite that includes editors and viewers for text documents, spreadsheets, and presentations.<br><br>The **elestio_onlyoffice** resource allows the creation and management of Elestio OnlyOffice services. The service uses the following docker image [onlyoffice/communityserver](https://hub.docker.com/r/onlyoffice/communityserver)
...
```shell
# Import a OnlyOffice service by specifying the Project ID it belongs to, and the OnlyOffice service ID (spaced by a comma).
terraform import elestio_onlyoffice.my_onlyoffice project_id,onlyoffice_service_id
```
