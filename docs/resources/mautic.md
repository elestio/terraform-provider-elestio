...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Mautic-HOef.png" width="100" height="100" /><br/> Mautic is a resource that creates a service with the `template_id = 209`. Mautic is a open source marketing automation software.
