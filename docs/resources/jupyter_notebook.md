...
subcategory: ""
description: |-
  Jupyter Notebook is a resource that creates a service with the template_id = 112. Jupyter Notebook is a web-based notebook environment for interactive computing.
---

# elestio_jupyter_notebook (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/3614431017-5d4c573bbdc0c-articlex-R2PE.png" width="100" height="100" /><br/><br/> Jupyter Notebook is a resource that creates a service with the `template_id = 112`. Jupyter Notebook is a web-based notebook environment for interactive computing.
