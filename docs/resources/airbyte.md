...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/airbyte-new-logo-a0OK.svg" width="100" height="100" /><br/> Airbyte is a resource that creates a service with the `template_id = 157`. Airbyte is an open-source data integration platform that syncs data from applications, APIs, and databases to warehouses
