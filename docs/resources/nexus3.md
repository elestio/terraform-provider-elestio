...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Nexus3-AVm3.png" width="100" height="100" /><br/> Nexus3 is a resource that creates a service with the `template_id = 225`. The free artifact repository with universal format support.
