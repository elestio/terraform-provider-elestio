...
page_title: "elestio_devlake Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  A dev data platform that ingests, analyzes, and visualizes the fragmented data from DevOps tools to extract insights for engineering excellence, developer experience, and community growthThe elestio_devlake resource allows the creation and management of Elestio DevLake services. The service uses the following docker image apache/devlake https://hub.docker.com/r/apache/devlake
---

# elestio_devlake (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/DevLake-SZev.png" width="100" /><br>A dev data platform that ingests, analyzes, and visualizes the fragmented data from DevOps tools to extract insights for engineering excellence, developer experience, and community growth<br><br>The **elestio_devlake** resource allows the creation and management of Elestio DevLake services. The service uses the following docker image [apache/devlake](https://hub.docker.com/r/apache/devlake)
...
```shell
# Import a DevLake service by specifying the Project ID it belongs to, and the DevLake service ID (spaced by a comma).
terraform import elestio_devlake.my_devlake project_id,devlake_service_id
```
