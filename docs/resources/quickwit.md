...
page_title: "elestio_quickwit Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Cloud-native search engine for observability. An open-source alternative to Datadog, Elasticsearch, Loki, and Tempo.The elestio_quickwit resource allows the creation and management of Elestio Quickwit services. The service uses the following docker image quickwit/quickwit https://hub.docker.com/r/quickwit/quickwit
---

# elestio_quickwit (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Quickwit-RfzS.png" width="100" /><br>Cloud-native search engine for observability. An open-source alternative to Datadog, Elasticsearch, Loki, and Tempo.<br><br>The **elestio_quickwit** resource allows the creation and management of Elestio Quickwit services. The service uses the following docker image [quickwit/quickwit](https://hub.docker.com/r/quickwit/quickwit)
...
```shell
# Import a Quickwit service by specifying the Project ID it belongs to, and the Quickwit service ID (spaced by a comma).
terraform import elestio_quickwit.my_quickwit project_id,quickwit_service_id
```
