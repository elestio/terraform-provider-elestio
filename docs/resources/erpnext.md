...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/erpnext-logo-blue-v2-3sEa.png" width="100" height="100" /><br/> ErpNext is a resource that creates a service with the `template_id = 120`. ERPNext is the leading open-source enterprise resource planning (ERP) software.
