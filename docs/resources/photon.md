...
```shell
# Import a Photon service by specifying the Project ID it belongs to, and the Photon service ID (spaced by a comma).
terraform import elestio_photon.my_photon project_id,photon_service_id
```
