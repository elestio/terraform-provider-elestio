...
page_title: "elestio_docassemble Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A free, open-source expert system for guided interviews and document assembly, based on Python, YAML, and Markdown.The elestio_docassemble resource allows the creation and management of Elestio Docassemble services. The service uses the following docker image jhpyle/docassemble https://hub.docker.com/r/jhpyle/docassemble
---

# elestio_docassemble (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/docassemble-1-5yqj.png" width="100" /><br>A free, open-source expert system for guided interviews and document assembly, based on Python, YAML, and Markdown.<br><br>The **elestio_docassemble** resource allows the creation and management of Elestio Docassemble services. The service uses the following docker image [jhpyle/docassemble](https://hub.docker.com/r/jhpyle/docassemble)
...
```shell
# Import a Docassemble service by specifying the Project ID it belongs to, and the Docassemble service ID (spaced by a comma).
terraform import elestio_docassemble.my_docassemble project_id,docassemble_service_id
```
