...
description: |-
  OneDev is an open-source all-in-one DevOps platform.The elestio_onedev resource allows the creation and management of Elestio Onedev services. The service uses the following docker image 1dev/server https://hub.docker.com/r/1dev/server
---
