...
```shell
# Import a rke2 service by specifying the Project ID it belongs to, and the rke2 service ID (spaced by a comma).
terraform import elestio_rke2.my_rke2 project_id,rke2_service_id
```
