...
```shell
# Import a Eneo service by specifying the Project ID it belongs to, and the Eneo service ID (spaced by a comma).
terraform import elestio_eneo.my_eneo project_id,eneo_service_id
```
