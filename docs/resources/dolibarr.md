...
description: |-
  Dolibarr ERP CRM is a modern software package to manage your company or foundation's activityThe elestio_dolibarr resource allows the creation and management of Elestio Dolibarr services. The service uses the following docker image upshift/dolibarr https://hub.docker.com/r/upshift/dolibarr
---
