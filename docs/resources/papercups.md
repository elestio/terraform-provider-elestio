...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/68310464-Fwoy.png" width="100" height="100" /><br/> Papercups is a resource that creates a service with the `template_id = 197`. Papercups is a open-source live customer chat
