...
page_title: "elestio_minthcm Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Human Capital Management system (HCM) that you can start using today to manage your HR departments and businesses in different branches.The elestio_minthcm resource allows the creation and management of Elestio MintHCM services. The service uses the following docker image minthcm/minthcm https://hub.docker.com/r/minthcm/minthcm
---

# elestio_minthcm (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/MintHCM-tKcx.png" width="100" /><br>Human Capital Management system (HCM) that you can start using today to manage your HR departments and businesses in different branches.<br><br>The **elestio_minthcm** resource allows the creation and management of Elestio MintHCM services. The service uses the following docker image [minthcm/minthcm](https://hub.docker.com/r/minthcm/minthcm)
...
```shell
# Import a MintHCM service by specifying the Project ID it belongs to, and the MintHCM service ID (spaced by a comma).
terraform import elestio_minthcm.my_minthcm project_id,minthcm_service_id
```
