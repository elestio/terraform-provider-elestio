...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/opensearch-twitter-card-D0aD.png" width="100" height="100" /><br/> OpenSearch is a resource that creates a service with the `template_id = 195`. Open source distributed and RESTful search engine.
