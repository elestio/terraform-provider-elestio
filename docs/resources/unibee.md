...
page_title: "elestio_unibee Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Automate Subscription Billing & Recurring Payments Unify subscriptions, real-time usage metering, and multiple payment gatewaysThe elestio_unibee resource allows the creation and management of Elestio UniBee services. The service uses the following docker image unibee/user-portal https://hub.docker.com/r/unibee/user-portal
---

# elestio_unibee (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/UniBee-NUpJ.png" width="100" /><br>Automate Subscription Billing & Recurring Payments Unify subscriptions, real-time usage metering, and multiple payment gateways<br><br>The **elestio_unibee** resource allows the creation and management of Elestio UniBee services. The service uses the following docker image [unibee/user-portal](https://hub.docker.com/r/unibee/user-portal)
...
- `version` (String) This is the version of the software used as service. **Default** `v1.7.3`.
...
```shell
# Import a UniBee service by specifying the Project ID it belongs to, and the UniBee service ID (spaced by a comma).
terraform import elestio_unibee.my_unibee project_id,unibee_service_id
```
