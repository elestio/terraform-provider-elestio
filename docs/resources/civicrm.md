...
page_title: "elestio_civicrm Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open Source CRM For Nonprofits WorldwideThe elestio_civicrm resource allows the creation and management of Elestio CiviCRM services. The service uses the following docker image civicrm/civicrm https://hub.docker.com/r/civicrm/civicrm
---

# elestio_civicrm (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/CiviCRM-xTyP.png" width="100" /><br>Open Source CRM For Nonprofits Worldwide<br><br>The **elestio_civicrm** resource allows the creation and management of Elestio CiviCRM services. The service uses the following docker image [civicrm/civicrm](https://hub.docker.com/r/civicrm/civicrm)
...
```shell
# Import a CiviCRM service by specifying the Project ID it belongs to, and the CiviCRM service ID (spaced by a comma).
terraform import elestio_civicrm.my_civicrm project_id,civicrm_service_id
```
