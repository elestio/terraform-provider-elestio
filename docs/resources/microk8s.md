...
subcategory: ""
description: |-
  MicroK8s is a small, fast, single-package Kubernetes for developers, IoT and edgeelestio_microk8s is a preconfigured elestio_service resource (template_id: 180) running Microk8s.
---
