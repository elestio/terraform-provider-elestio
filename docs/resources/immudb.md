...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/ImmuDB-P3Sd.png" width="100" height="100" /><br/> ImmuDB is a resource that creates a service with the `template_id = 251`. immutable ledger database based on zero trust, SQL and Key-Value, tamperproof, data change history
