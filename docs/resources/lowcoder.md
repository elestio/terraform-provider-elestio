...
- `version` (String) This is the version of the software used as service. **Default** `2.4.7`.
...
```shell
# Import a Lowcoder service by specifying the Project ID it belongs to, and the Lowcoder service ID (spaced by a comma).
terraform import elestio_lowcoder.my_lowcoder project_id,lowcoder_service_id
```
