...
page_title: "elestio_meshcommander Resource - terraform-provider-elestio"
subcategory: "Services: Hosting & Infra"
description: |-
  MeshCommander is the ultimate open source Intel AMT management console. The elestio_meshcommander resource allows the creation and management of Elestio MeshCommander services. The service uses the following docker image elestio/meshcommander https://hub.docker.com/r/elestio/meshcommander
---

# elestio_meshcommander (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/MeshCentral-vuNF.png" width="100" /><br>MeshCommander is the ultimate open source Intel AMT management console. <br><br>The **elestio_meshcommander** resource allows the creation and management of Elestio MeshCommander services. The service uses the following docker image [elestio/meshcommander](https://hub.docker.com/r/elestio/meshcommander)
...
```shell
# Import a MeshCommander service by specifying the Project ID it belongs to, and the MeshCommander service ID (spaced by a comma).
terraform import elestio_meshcommander.my_meshcommander project_id,meshcommander_service_id
```
