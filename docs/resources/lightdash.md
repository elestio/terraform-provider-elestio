...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Lightdash-NVQX.png" width="100" height="100" /><br/> Lightdash is a resource that creates a service with the `template_id = 205`. Lighdash an open source alternative to Looker built using dbt.
