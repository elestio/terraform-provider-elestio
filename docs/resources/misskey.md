...
page_title: "elestio_misskey Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Misskey is an open-source microblogging, federated social media platform that's free forever! The elestio_misskey resource allows the creation and management of Elestio Misskey services. The service uses the following docker image misskey/misskey https://hub.docker.com/r/misskey/misskey
---

# elestio_misskey (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Misskey-NMCz.png" width="100" /><br>Misskey is an open-source microblogging, federated social media platform that's free forever! <br><br>The **elestio_misskey** resource allows the creation and management of Elestio Misskey services. The service uses the following docker image [misskey/misskey](https://hub.docker.com/r/misskey/misskey)
...
```shell
# Import a Misskey service by specifying the Project ID it belongs to, and the Misskey service ID (spaced by a comma).
terraform import elestio_misskey.my_misskey project_id,misskey_service_id
```
