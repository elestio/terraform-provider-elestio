...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/logo-canopsis-vert-jgxH.png" width="100" height="100" /><br/> The first open-source hypervision solution<br/><br/>**elestio_canopsis** is a preconfigured elestio_service resource (`template_id: 259`) running **Canopsis** ([`docker_image: canopsis/canopsis-api`](https://hub.docker.com/r/canopsis/canopsis-api)).
