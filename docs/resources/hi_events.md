...
page_title: "elestio_hi_events Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Event management and ticket selling platform 🎟️The elestio_hi_events resource allows the creation and management of Elestio Hi-events services. The service uses the following docker image daveearley/hi.events-all-in-one https://hub.docker.com/r/daveearley/hi.events-all-in-one
---

# elestio_hi_events (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Hi-events-uFdE.png" width="100" /><br>Event management and ticket selling platform 🎟️<br><br>The **elestio_hi_events** resource allows the creation and management of Elestio Hi-events services. The service uses the following docker image [daveearley/hi.events-all-in-one](https://hub.docker.com/r/daveearley/hi.events-all-in-one)
...
```shell
# Import a Hi-events service by specifying the Project ID it belongs to, and the Hi-events service ID (spaced by a comma).
terraform import elestio_hi_events.my_hi_events project_id,hi_events_service_id
```
