...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Zabbix-BQ4C.png" width="100" height="100" /><br/> Zabbix is a resource that creates a service with the `template_id = 231`. Zabbix is an enterprise-class open source distributed monitoring solution.
