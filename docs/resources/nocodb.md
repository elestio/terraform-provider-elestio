...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nocodb-lrBE.png" width="100" height="100" /><br/> NocoDB is a resource that creates a service with the `template_id = 117`. NocoDB is an open-source #NoCode platform that turns any database into a smart spreadsheet.
