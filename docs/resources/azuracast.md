...
subcategory: ""
description: |-
  AzuraCast Resource is a preconfigured Service Resource with the template_id = 222. A self-hosted web radio management suite Docker hub image: azuracast/azuracast https://hub.docker.com/r/azuracast/azuracast
---

# elestio_azuracast (Resource)

AzuraCast Resource is a preconfigured Service Resource with the `template_id = 222`.<br/><br/><img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/AzuraCast-aDBt.png" width="100" height="100" /><br/> A self-hosted web radio management suite<br/><br/> Docker hub image: [`azuracast/azuracast`](https://hub.docker.com/r/azuracast/azuracast)
