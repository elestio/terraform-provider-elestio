...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/uptimeKuma1-PPKD.png" width="100" height="100" /><br/> Uptime-kuma is a resource that creates a service with the `template_id = 137`. Uptime Kuma is a self-hosted monitoring tool like Uptime Robot.
