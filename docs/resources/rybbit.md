...
```shell
# Import a Rybbit service by specifying the Project ID it belongs to, and the Rybbit service ID (spaced by a comma).
terraform import elestio_rybbit.my_rybbit project_id,rybbit_service_id
```
