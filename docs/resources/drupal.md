...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/drupal-wordmark-AULA.png" width="100" height="100" /><br/> Drupal is a resource that creates a service with the `template_id = 96`. Drupal is an open-source content management platform that supports a wide variety of websites.
