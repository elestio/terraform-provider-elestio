...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Gerrit-WauR.png" width="100" height="100" /><br/> Gerrit is a resource that creates a service with the `template_id = 262`. Gerrit is a code review and project management tool for Git based projects.
