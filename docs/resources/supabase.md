...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/supabase-TAiY.png" width="100" height="100" /><br/> Supabase is a resource that creates a service with the `template_id = 284`. Supabase is an open source alternative to Firebase.
