...
```shell
# Import a Bytebase service by specifying the Project ID it belongs to, and the Bytebase service ID (spaced by a comma).
terraform import elestio_bytebase.my_bytebase project_id,bytebase_service_id
```
