...
page_title: "elestio_humhub Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  HumHub to communicate and collaborate, share information, interact with all people in your organization, and personalize the software to fit your individual needs.The elestio_humhub resource allows the creation and management of Elestio HumHub services. The service uses the following docker image mriedmann/humhub https://hub.docker.com/r/mriedmann/humhub
---

# elestio_humhub (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/HumHub-citG.png" width="100" /><br>HumHub to communicate and collaborate, share information, interact with all people in your organization, and personalize the software to fit your individual needs.<br><br>The **elestio_humhub** resource allows the creation and management of Elestio HumHub services. The service uses the following docker image [mriedmann/humhub](https://hub.docker.com/r/mriedmann/humhub)
...
```shell
# Import a HumHub service by specifying the Project ID it belongs to, and the HumHub service ID (spaced by a comma).
terraform import elestio_humhub.my_humhub project_id,humhub_service_id
```
