...
description: |-
  Open Translation Management Platform. Teams use Ever Traduora to reach users all around the globe. Automate your translation workflow todayThe elestio_traduora resource allows the creation and management of Elestio Traduora services. The service uses the following docker image everco/ever-traduora https://hub.docker.com/r/everco/ever-traduora
---
...
```shell
# Import a Traduora service by specifying the Project ID it belongs to, and the Traduora service ID (spaced by a comma).
terraform import elestio_traduora.my_traduora project_id,traduora_service_id
```
