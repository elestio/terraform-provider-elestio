...
```shell
# Import a Kafka service by specifying the Project ID it belongs to, and the Kafka service ID (spaced by a comma).
terraform import elestio_kafka.my_kafka project_id,kafka_service_id
```
