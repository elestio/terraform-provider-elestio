...
page_title: "elestio_dashy Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  The Ultimate Homepage for your HomelabThe elestio_dashy resource allows the creation and management of Elestio Dashy services. The service uses the following docker image lissy93/dashy https://hub.docker.com/r/lissy93/dashy
---

# elestio_dashy (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/dashy-36oD.png" width="100" /><br>The Ultimate Homepage for your Homelab<br><br>The **elestio_dashy** resource allows the creation and management of Elestio Dashy services. The service uses the following docker image [lissy93/dashy](https://hub.docker.com/r/lissy93/dashy)
...
```shell
# Import a Dashy service by specifying the Project ID it belongs to, and the Dashy service ID (spaced by a comma).
terraform import elestio_dashy.my_dashy project_id,dashy_service_id
```
