...
description: |-
  NocoDB is an open-source #NoCode platform that turns any database into a smart spreadsheet.The elestio_nocodb resource allows the creation and management of Elestio NocoDB services. The service uses the following docker image nocodb/nocodb https://hub.docker.com/r/nocodb/nocodb
---

# elestio_nocodb (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nocodb-lrBE.png" width="100" /><br>NocoDB is an open-source #NoCode platform that turns any database into a smart spreadsheet.<br><br>The **elestio_nocodb** resource allows the creation and management of Elestio NocoDB services. The service uses the following docker image [nocodb/nocodb](https://hub.docker.com/r/nocodb/nocodb)
...
```shell
# Import a NocoDB service by specifying the Project ID it belongs to, and the NocoDB service ID (spaced by a comma).
terraform import elestio_nocodb.my_nocodb project_id,nocodb_service_id
```
