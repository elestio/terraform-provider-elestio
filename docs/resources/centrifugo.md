...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/centrifugo-zHJH.svg" width="100" height="100" /><br/> Centrifugo is a resource that creates a service with the `template_id = 151`. Centrifugo is a scalable real-time, language-agnostic messaging server.
