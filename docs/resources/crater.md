...
page_title: "elestio_crater Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Crater helps you track expenses, and payments & create professional invoices & estimates.The elestio_crater resource allows the creation and management of Elestio Crater services. The service uses the following docker image shinsenter/crater https://hub.docker.com/r/shinsenter/crater
---

# elestio_crater (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Crater-24fD.png" width="100" /><br>Crater helps you track expenses, and payments & create professional invoices & estimates.<br><br>The **elestio_crater** resource allows the creation and management of Elestio Crater services. The service uses the following docker image [shinsenter/crater](https://hub.docker.com/r/shinsenter/crater)
...
- `version` (String) This is the version of the software used as service. **Default** `php8.1-deprecated`.
...
```shell
# Import a Crater service by specifying the Project ID it belongs to, and the Crater service ID (spaced by a comma).
terraform import elestio_crater.my_crater project_id,crater_service_id
```
