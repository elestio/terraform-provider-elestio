...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/mailcow-g4H1.png" width="100" height="100" /><br/> MailCow is a resource that creates a service with the `template_id = 122`. Mailcow is a mail server suite with an elegant web interface for managing domains, mailboxes, etc.
