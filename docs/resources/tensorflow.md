...
page_title: "elestio_tensorflow Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  An Open-Source Machine Learning Framework for EveryoneThe elestio_tensorflow resource allows the creation and management of Elestio TensorFlow services. The service uses the following docker image tensorflow/tensorflow https://hub.docker.com/r/tensorflow/tensorflow
---

# elestio_tensorflow (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/TensorFlow-3muA.png" width="100" /><br>An Open-Source Machine Learning Framework for Everyone<br><br>The **elestio_tensorflow** resource allows the creation and management of Elestio TensorFlow services. The service uses the following docker image [tensorflow/tensorflow](https://hub.docker.com/r/tensorflow/tensorflow)
...
- `version` (String) This is the version of the software used as service. **Default** `latest-gpu-jupyter`.
...
```shell
# Import a TensorFlow service by specifying the Project ID it belongs to, and the TensorFlow service ID (spaced by a comma).
terraform import elestio_tensorflow.my_tensorflow project_id,tensorflow_service_id
```
