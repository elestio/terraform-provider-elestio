...
page_title: "elestio_pleroma Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A microblogging server software that can federate other servers that support ActivityPub. it will federate with all servers like Friendica, GNU Social, Hubzilla, Mastodon, Misskey, Peertube, and Pixelfed.The elestio_pleroma resource allows the creation and management of Elestio Pleroma services. The service uses the following docker image elestio/pleroma https://hub.docker.com/r/elestio/pleroma
---

# elestio_pleroma (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Pleroma-jgwH.png" width="100" /><br>A microblogging server software that can federate other servers that support ActivityPub. it will federate with all servers like Friendica, GNU Social, Hubzilla, Mastodon, Misskey, Peertube, and Pixelfed.<br><br>The **elestio_pleroma** resource allows the creation and management of Elestio Pleroma services. The service uses the following docker image [elestio/pleroma](https://hub.docker.com/r/elestio/pleroma)
...
```shell
# Import a Pleroma service by specifying the Project ID it belongs to, and the Pleroma service ID (spaced by a comma).
terraform import elestio_pleroma.my_pleroma project_id,pleroma_service_id
```
