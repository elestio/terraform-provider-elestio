...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/haproxy-BB8J.png" width="100" height="100" /><br/> HAProxy is a resource that creates a service with the `template_id = 215`. The Reliable, High Performance TCP/HTTP Load Balancer
