...
page_title: "elestio_rustfs Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  RustFS is a high-performance, distributed object storage system built in Rust—one of the most loved programming languages worldwide. RustFS combines the simplicity of MinIO with the memory safety and raw performance of Rust. It offers full S3 compatibilitThe elestio_rustfs resource allows the creation and management of Elestio RustFS services. The service uses the following docker image rustfs/rustfs https://hub.docker.com/r/rustfs/rustfs
---

# elestio_rustfs (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/RustFS-EzTG.png" width="100" /><br>RustFS is a high-performance, distributed object storage system built in Rust—one of the most loved programming languages worldwide. RustFS combines the simplicity of MinIO with the memory safety and raw performance of Rust. It offers full S3 compatibilit<br><br>The **elestio_rustfs** resource allows the creation and management of Elestio RustFS services. The service uses the following docker image [rustfs/rustfs](https://hub.docker.com/r/rustfs/rustfs)
...
```shell
# Import a RustFS service by specifying the Project ID it belongs to, and the RustFS service ID (spaced by a comma).
terraform import elestio_rustfs.my_rustfs project_id,rustfs_service_id
```
