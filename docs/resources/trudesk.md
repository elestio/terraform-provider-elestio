...
description: |-
  Trudesk is an open-source help desk/ticketing solution.The elestio_trudesk resource allows the creation and management of Elestio Trudesk services. The service uses the following docker image polonel/trudesk https://hub.docker.com/r/polonel/trudesk
---
