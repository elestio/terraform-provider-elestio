...
page_title: "elestio_iomad Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  IOMAD is a multi-tenancy solution for business, corporate, and workplace Moodle markets.The elestio_iomad resource allows the creation and management of Elestio IOMAD services. The service uses the following docker image elestio/iomad https://hub.docker.com/r/elestio/iomad
---

# elestio_iomad (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/IOMAD-dOm7.png" width="100" /><br>IOMAD is a multi-tenancy solution for business, corporate, and workplace Moodle markets.<br><br>The **elestio_iomad** resource allows the creation and management of Elestio IOMAD services. The service uses the following docker image [elestio/iomad](https://hub.docker.com/r/elestio/iomad)
...
```shell
# Import a IOMAD service by specifying the Project ID it belongs to, and the IOMAD service ID (spaced by a comma).
terraform import elestio_iomad.my_iomad project_id,iomad_service_id
```
