...
```shell
# Import a CryptPad service by specifying the Project ID it belongs to, and the CryptPad service ID (spaced by a comma).
terraform import elestio_cryptpad.my_cryptpad project_id,cryptpad_service_id
```
