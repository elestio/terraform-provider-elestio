...
page_title: "elestio_repman Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Repman: PHP Repository Manager: packagist proxy and host for private packagesThe elestio_repman resource allows the creation and management of Elestio Repman services. The service uses the following docker image buddy/repman https://hub.docker.com/r/buddy/repman
---

# elestio_repman (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Repman-Rw5V.png" width="100" /><br>Repman: PHP Repository Manager: packagist proxy and host for private packages<br><br>The **elestio_repman** resource allows the creation and management of Elestio Repman services. The service uses the following docker image [buddy/repman](https://hub.docker.com/r/buddy/repman)
...
```shell
# Import a Repman service by specifying the Project ID it belongs to, and the Repman service ID (spaced by a comma).
terraform import elestio_repman.my_repman project_id,repman_service_id
```
