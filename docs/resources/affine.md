...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Affine-KOfL.png" width="100" height="100" /><br/> Affine is a resource that creates a service with the `template_id = 294`. More than Notion and Miro's next-generation knowledge base, AFFiNE unifies planning, sorting, and creation.
