...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/WooCommerce-bPyg.png" width="100" height="100" /><br/> WooCommerce is a resource that creates a service with the `template_id = 296`. WooCommerce is a customizable, open-source eCommerce platform built on WordPress.
