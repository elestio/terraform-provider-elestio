...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Stirling-PDF-GYNm.png" width="100" /><br>Web application that allows you to perform various operations on PDF files.<br><br>The **elestio_stirling_pdf** resource allows the creation and management of Elestio Stirling-PDF services. The service uses the following docker image [frooodle/s-pdf](https://hub.docker.com/r/frooodle/s-pdf)
...
```shell
# Import a Stirling-PDF service by specifying the Project ID it belongs to, and the Stirling-PDF service ID (spaced by a comma).
terraform import elestio_stirling_pdf.my_stirling_pdf project_id,stirling_pdf_service_id
```
