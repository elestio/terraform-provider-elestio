...
page_title: "elestio_automatisch Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Automatisch helps you to automate your business processes without coding. Use our affordable cloud solution or self-host on your own servers.The elestio_automatisch resource allows the creation and management of Elestio Automatisch services. The service uses the following docker image automatischio/automatisch https://hub.docker.com/r/automatischio/automatisch
---
...
```shell
# Import a Automatisch service by specifying the Project ID it belongs to, and the Automatisch service ID (spaced by a comma).
terraform import elestio_automatisch.my_automatisch project_id,automatisch_service_id
```
