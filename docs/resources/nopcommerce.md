...
subcategory: ""
description: |-
  nopCommerce is a resource that creates a service with the template_id = 217. nopCommerce is the most popular ASP.NET shopping cart in the world based on Microsoft technologies. Free and open-source eCommerce platform.
---

# elestio_nopcommerce (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nopcommerce-NcUG.svg" width="100" height="100" /><br/><br/> nopCommerce is a resource that creates a service with the `template_id = 217`. nopCommerce is the most popular ASP.NET shopping cart in the world based on Microsoft technologies. Free and open-source eCommerce platform.
