...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/ackee2-9kWq.png" width="100" height="100" /><br/> Ackee is a resource that creates a service with the `template_id = 133`. Ackee is a self-hosted, Node.js-based analytics tool for ensuring privacy.
