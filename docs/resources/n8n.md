...
subcategory: ""
description: |-
  n8n is a free, self-hosted workflow automation tool that integrates with other apps to automate processes between them.elestio_n8n is a preconfigured elestioservice resource (template_id: 54) running N8N ([`dockerimage: n8nio/n8n`](https://hub.docker.com/r/n8nio/n8n)).
---
