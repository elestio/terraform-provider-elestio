...
subcategory: ""
description: |-
  Imagor is a fast, Docker-ready image processing server.elestio_imagor is a preconfigured elestioservice resource (template_id: 203) running Imagor ([`dockerimage: shumc/imagor`](https://hub.docker.com/r/shumc/imagor)).
---

# elestio_imagor (Resource)

<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/imagor-wsHT.png" width="100" height="100" /><br/> Imagor is a fast, Docker-ready image processing server.<br/><br/>**elestio_imagor** is a preconfigured elestio_service resource (`template_id: 203`) running **Imagor** ([`docker_image: shumc/imagor`](https://hub.docker.com/r/shumc/imagor)).
...
```shell
# Import a Imagor service by specifying the Project ID it belongs to, and the Imagor service ID (spaced by a comma).
terraform import elestio_imagor.my_imagor project_id,imagor_service_id
```
