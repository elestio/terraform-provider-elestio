...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/1200px-OwnCloud-logo-and-wordmark-nqoe.png" width="100" height="100" /><br/> ownCloud is a resource that creates a service with the `template_id = 150`. ownCloud is a suite of client-server software for creating and using file hosting services.
