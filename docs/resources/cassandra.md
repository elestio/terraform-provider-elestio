...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Cassandra-npTG.png" width="100" height="100" /><br/> Open Source NoSQL Database<br/><br/>**elestio_cassandra** is a preconfigured elestio_service resource (`template_id: 253`) running **Cassandra** ([`docker_image: bitnami/cassandra`](https://hub.docker.com/r/bitnami/cassandra)).
