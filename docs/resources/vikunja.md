...
page_title: "elestio_vikunja Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  The open-source to-do app. Organize everything, on all platforms.The elestio_vikunja resource allows the creation and management of Elestio Vikunja services. The service uses the following docker image elestio/vikunja https://hub.docker.com/r/elestio/vikunja
---

# elestio_vikunja (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Vikunja-NMTN.png" width="100" /><br>The open-source to-do app. Organize everything, on all platforms.<br><br>The **elestio_vikunja** resource allows the creation and management of Elestio Vikunja services. The service uses the following docker image [elestio/vikunja](https://hub.docker.com/r/elestio/vikunja)
...
```shell
# Import a Vikunja service by specifying the Project ID it belongs to, and the Vikunja service ID (spaced by a comma).
terraform import elestio_vikunja.my_vikunja project_id,vikunja_service_id
```
