...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Knime-Z1mn.png" width="100" height="100" /><br/> Knime is a resource that creates a service with the `template_id = 238`. KNIME Analytics Platform
