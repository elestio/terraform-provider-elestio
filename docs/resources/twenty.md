...
page_title: "elestio_twenty Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open-source CRM, Building a modern alternative to Salesforce, powered by the community.The elestio_twenty resource allows the creation and management of Elestio Twenty services. The service uses the following docker image twentycrm/twenty https://hub.docker.com/r/twentycrm/twenty
---

# elestio_twenty (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Twenty-ZipA.png" width="100" /><br>Open-source CRM, Building a modern alternative to Salesforce, powered by the community.<br><br>The **elestio_twenty** resource allows the creation and management of Elestio Twenty services. The service uses the following docker image [twentycrm/twenty](https://hub.docker.com/r/twentycrm/twenty)
...
- `version` (String) This is the version of the software used as service. **Default** `v0.30.0`.
...
```shell
# Import a Twenty service by specifying the Project ID it belongs to, and the Twenty service ID (spaced by a comma).
terraform import elestio_twenty.my_twenty project_id,twenty_service_id
```
