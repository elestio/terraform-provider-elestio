...
description: |-
  Papercups is a open-source live customer chatThe elestio_papercups resource allows the creation and management of Elestio Papercups services. The service uses the following docker image papercups/papercups https://hub.docker.com/r/papercups/papercups
---
