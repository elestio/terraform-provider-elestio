...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/PostgreSQL-Logo--1--i1yU.png" width="100" height="100" /><br/> PostgreSQL is a resource that creates a service with the `template_id = 11`. PostgreSQL is a powerful, open-source object-relational database system, known for reliability, data integrity and performance.
