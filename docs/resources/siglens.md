...
page_title: "elestio_siglens Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  100x Efficient Log Management than Splunk 🚀 Reduce your observability cost by 90%The elestio_siglens resource allows the creation and management of Elestio SigLens services. The service uses the following docker image elestio/siglens https://hub.docker.com/r/elestio/siglens
---

# elestio_siglens (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/SigLens-VZ9I.png" width="100" /><br>100x Efficient Log Management than Splunk 🚀 Reduce your observability cost by 90%<br><br>The **elestio_siglens** resource allows the creation and management of Elestio SigLens services. The service uses the following docker image [elestio/siglens](https://hub.docker.com/r/elestio/siglens)
...
```shell
# Import a SigLens service by specifying the Project ID it belongs to, and the SigLens service ID (spaced by a comma).
terraform import elestio_siglens.my_siglens project_id,siglens_service_id
```
