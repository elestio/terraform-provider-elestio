...
page_title: "elestio_glpi Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  GLPI is a Free Asset and IT Management Software package, Data center management, ITIL Service Desk, licenses tracking and software auditing.The elestio_glpi resource allows the creation and management of Elestio GLPI services. The service uses the following docker image elestio/glpi https://hub.docker.com/r/elestio/glpi
---
...
```shell
# Import a GLPI service by specifying the Project ID it belongs to, and the GLPI service ID (spaced by a comma).
terraform import elestio_glpi.my_glpi project_id,glpi_service_id
```
