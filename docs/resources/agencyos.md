...
```shell
# Import a AgencyOS service by specifying the Project ID it belongs to, and the AgencyOS service ID (spaced by a comma).
terraform import elestio_agencyos.my_agencyos project_id,agencyos_service_id
```
