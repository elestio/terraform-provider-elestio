...
page_title: "elestio_hermes Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  The self-improving AI agent built by Nous Research. It's the only agent with a built-in learning loop.The elestio_hermes resource allows the creation and management of Elestio Hermes services. The service uses the following docker image nousresearch/hermes-agent https://hub.docker.com/r/nousresearch/hermes-agent
---

# elestio_hermes (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Hermes-3MI8.png" width="100" /><br>The self-improving AI agent built by Nous Research. It's the only agent with a built-in learning loop.<br><br>The **elestio_hermes** resource allows the creation and management of Elestio Hermes services. The service uses the following docker image [nousresearch/hermes-agent](https://hub.docker.com/r/nousresearch/hermes-agent)
...
```shell
# Import a Hermes service by specifying the Project ID it belongs to, and the Hermes service ID (spaced by a comma).
terraform import elestio_hermes.my_hermes project_id,hermes_service_id
```
