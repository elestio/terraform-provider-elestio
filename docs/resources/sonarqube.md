...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Sonarqube-uUXv.png" width="100" height="100" /><br/> SonarQube is a resource that creates a service with the `template_id = 113`. SonarQube is an open-source platform that reveals the health of an application and highlights new issues.
