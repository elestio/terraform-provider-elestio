...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Authentik-logo-RG9c.png" width="100" height="100" /><br/> Authentik is a resource that creates a service with the `template_id = 174`. authentik is a flexible, versatile open-source identity provider.
