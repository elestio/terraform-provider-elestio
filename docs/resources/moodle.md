...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Moodle-PYvu.png" width="100" height="100" /><br/> Moodle is a resource that creates a service with the `template_id = 107`. Moodle is the world's most popular open-source learning platform for educators to create their own websites.
