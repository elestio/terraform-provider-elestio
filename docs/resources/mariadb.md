...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/MariaDB-RfXk.png" width="100" height="100" /><br/> MariaDB is a resource that creates a service with the `template_id = 270`. The open source relational database
