...
```shell
# Import a Magento service by specifying the Project ID it belongs to, and the Magento service ID (spaced by a comma).
terraform import elestio_magento.my_magento project_id,magento_service_id
```
