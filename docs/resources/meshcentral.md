...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/MeshCentral-vuNF.png" width="100" height="100" /><br/> MeshCentral is a resource that creates a service with the `template_id = 281`. MeshCentral is a full computer management web site
