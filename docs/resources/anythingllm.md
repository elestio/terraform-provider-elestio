...
page_title: "elestio_anythingllm Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  The all-in-one Desktop & Docker AI application with full RAG and AI Agent capabilities. Chat with your docs, use AI Agents, hyper-configurable.The elestio_anythingllm resource allows the creation and management of Elestio AnythingLLM services. The service uses the following docker image mintplexlabs/anythingllm https://hub.docker.com/r/mintplexlabs/anythingllm
---

# elestio_anythingllm (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/AnythingLLM-2eln.png" width="100" /><br>The all-in-one Desktop & Docker AI application with full RAG and AI Agent capabilities. Chat with your docs, use AI Agents, hyper-configurable.<br><br>The **elestio_anythingllm** resource allows the creation and management of Elestio AnythingLLM services. The service uses the following docker image [mintplexlabs/anythingllm](https://hub.docker.com/r/mintplexlabs/anythingllm)
...
```shell
# Import a AnythingLLM service by specifying the Project ID it belongs to, and the AnythingLLM service ID (spaced by a comma).
terraform import elestio_anythingllm.my_anythingllm project_id,anythingllm_service_id
```
