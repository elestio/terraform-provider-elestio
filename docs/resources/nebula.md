...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/1200px-Slack-icon-2019-oMDw.png" width="100" height="100" /><br/> Nebula is a resource that creates a service with the `template_id = 181`. Nebula is a scalable overlay networking tool with a focus on performance, simplicity and security
