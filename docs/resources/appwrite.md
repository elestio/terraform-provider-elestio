...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/appwritelogo-1-7ZXG.svg" width="100" height="100" /><br/> Appwrite is a resource that creates a service with the `template_id = 144`. Appwrite provides developers with a set of REST APIs to manage their core backend needs.
