...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/images-removebg-preview-9VVg.png" width="100" height="100" /><br/> Shopware is a resource that creates a service with the `template_id = 289`. Shopware is a modern eCommerce platform connecting enterprise-level capabilities with flexibility
