...
page_title: "elestio_unomi Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Apache Unomi stores user profile information and is mostly used to provide a backend server for A/B testing and personalizationThe elestio_unomi resource allows the creation and management of Elestio Unomi services. The service uses the following docker image apache/unomi https://hub.docker.com/r/apache/unomi
---

# elestio_unomi (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Unomi-wSuk.png" width="100" /><br>Apache Unomi stores user profile information and is mostly used to provide a backend server for A/B testing and personalization<br><br>The **elestio_unomi** resource allows the creation and management of Elestio Unomi services. The service uses the following docker image [apache/unomi](https://hub.docker.com/r/apache/unomi)
...
- `version` (String) This is the version of the software used as service. **Default** `2.6.0`.
...
```shell
# Import a Unomi service by specifying the Project ID it belongs to, and the Unomi service ID (spaced by a comma).
terraform import elestio_unomi.my_unomi project_id,unomi_service_id
```
