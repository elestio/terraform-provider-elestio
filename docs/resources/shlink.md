...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/shlink-logo-blue-svg-QBnL.png" width="100" height="100" /><br/> Shlink is a resource that creates a service with the `template_id = 239`. The definitive self-hosted URL shortener
