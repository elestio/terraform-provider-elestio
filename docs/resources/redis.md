...
subcategory: ""
description: |-
  Redis is an open-source, in-memory database, cache and message broker. elestio_redis is a preconfigured elestioservice resource (template_id: 3) running Redis ([`dockerimage: redis`](https://hub.docker.com/r/redis)).
---
