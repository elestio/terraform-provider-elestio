...
description: |-
  Create entire blueprints of what your new hire will go through within minutes. Simply drag and drop items into the timeline.The elestio_chiefonboarding resource allows the creation and management of Elestio ChiefOnboarding services. The service uses the following docker image chiefonboarding/chiefonboarding https://hub.docker.com/r/chiefonboarding/chiefonboarding
---
...
```shell
# Import a ChiefOnboarding service by specifying the Project ID it belongs to, and the ChiefOnboarding service ID (spaced by a comma).
terraform import elestio_chiefonboarding.my_chiefonboarding project_id,chiefonboarding_service_id
```
