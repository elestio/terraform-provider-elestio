...
subcategory: ""
description: |-
  This resource is the generic way to create a service. You can choose the software by providing the template_id as a parameter. You can look for available template ids in the templates documentation https://change.me.
---
