...
page_title: "elestio_uvdesk Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  UVdesk Opensource Community Helpdesk Project is built for all to make a full ticketing support system along with many more other features.The elestio_uvdesk resource allows the creation and management of Elestio UVdesk services. The service uses the following docker image dietermartens/uvdesk https://hub.docker.com/r/dietermartens/uvdesk
---

# elestio_uvdesk (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/UVdesk-cwPj.png" width="100" /><br>UVdesk Opensource Community Helpdesk Project is built for all to make a full ticketing support system along with many more other features.<br><br>The **elestio_uvdesk** resource allows the creation and management of Elestio UVdesk services. The service uses the following docker image [dietermartens/uvdesk](https://hub.docker.com/r/dietermartens/uvdesk)
...
```shell
# Import a UVdesk service by specifying the Project ID it belongs to, and the UVdesk service ID (spaced by a comma).
terraform import elestio_uvdesk.my_uvdesk project_id,uvdesk_service_id
```
