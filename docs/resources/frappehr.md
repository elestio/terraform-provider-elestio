...
page_title: "elestio_frappehr Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Frappe HR (ERPNext HRMS) is a user-friendly solution designed to streamline HR and payroll operations, driving excellence within your team.The elestio_frappehr resource allows the creation and management of Elestio FrappeHR services. The service uses the following docker image elestio/erpnext https://hub.docker.com/r/elestio/erpnext
---

# elestio_frappehr (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/FrappeHR-l9Em.png" width="100" /><br>Frappe HR (ERPNext HRMS) is a user-friendly solution designed to streamline HR and payroll operations, driving excellence within your team.<br><br>The **elestio_frappehr** resource allows the creation and management of Elestio FrappeHR services. The service uses the following docker image [elestio/erpnext](https://hub.docker.com/r/elestio/erpnext)
...
```shell
# Import a FrappeHR service by specifying the Project ID it belongs to, and the FrappeHR service ID (spaced by a comma).
terraform import elestio_frappehr.my_frappehr project_id,frappehr_service_id
```
