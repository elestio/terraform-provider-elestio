...
description: |-
  Apache Guacamole is a clientless remote desktop gateway.The elestio_guacamole resource allows the creation and management of Elestio Guacamole services. The service uses the following docker image guacamole/guacamole https://hub.docker.com/r/guacamole/guacamole
---
