...
description: |-
  HedgeDoc is an open-source, web-based, self-hosted, collaborative markdown editorThe elestio_hedgedoc resource allows the creation and management of Elestio HedgeDoc services. The service uses the following docker image quay.io/hedgedoc/hedgedoc https://hub.docker.com/r/quay.io/hedgedoc/hedgedoc
---
