...
page_title: "elestio_ragflow Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  Build Generative AI into Your BusinessThe elestio_ragflow resource allows the creation and management of Elestio Ragflow services. The service uses the following docker image infiniflow/ragflow https://hub.docker.com/r/infiniflow/ragflow
---

# elestio_ragflow (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/ragflow-Ahu7.png" width="100" /><br>Build Generative AI into Your Business<br><br>The **elestio_ragflow** resource allows the creation and management of Elestio Ragflow services. The service uses the following docker image [infiniflow/ragflow](https://hub.docker.com/r/infiniflow/ragflow)
...
- `version` (String) This is the version of the software used as service. **Default** `dev`.
...
```shell
# Import a Ragflow service by specifying the Project ID it belongs to, and the Ragflow service ID (spaced by a comma).
terraform import elestio_ragflow.my_ragflow project_id,ragflow_service_id
```
