...
```shell
# Import a Pixelfed service by specifying the Project ID it belongs to, and the Pixelfed service ID (spaced by a comma).
terraform import elestio_pixelfed.my_pixelfed project_id,pixelfed_service_id
```
