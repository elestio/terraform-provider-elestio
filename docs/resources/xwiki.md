...
page_title: "elestio_xwiki Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  XWiki Platform is a generic wiki platform offering runtime services for applications built on top of it.The elestio_xwiki resource allows the creation and management of Elestio XWiki services. The service uses the following docker image xwiki https://hub.docker.com/r/xwiki
---

# elestio_xwiki (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/XWiki-xSxw.png" width="100" /><br>XWiki Platform is a generic wiki platform offering runtime services for applications built on top of it.<br><br>The **elestio_xwiki** resource allows the creation and management of Elestio XWiki services. The service uses the following docker image [xwiki](https://hub.docker.com/r/xwiki)
...
- `version` (String) This is the version of the software used as service. **Default** `16.4.0-postgres-tomcat`.
...
```shell
# Import a XWiki service by specifying the Project ID it belongs to, and the XWiki service ID (spaced by a comma).
terraform import elestio_xwiki.my_xwiki project_id,xwiki_service_id
```
