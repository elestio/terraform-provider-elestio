...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nekologo-ALP3.png" width="100" height="100" /><br/> Neko Rooms is a resource that creates a service with the `template_id = 78`. Neko-Rooms is a simple room management system for n.eko.
