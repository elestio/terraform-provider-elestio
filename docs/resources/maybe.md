...
page_title: "elestio_maybe Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  OS for your personal financesThe elestio_maybe resource allows the creation and management of Elestio Maybe services. The service uses the following docker image maybe-finance/maybe https://hub.docker.com/r/maybe-finance/maybe
---

# elestio_maybe (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/maybe-dCQw.png" width="100" /><br>OS for your personal finances<br><br>The **elestio_maybe** resource allows the creation and management of Elestio Maybe services. The service uses the following docker image [maybe-finance/maybe](https://hub.docker.com/r/maybe-finance/maybe)
...
```shell
# Import a Maybe service by specifying the Project ID it belongs to, and the Maybe service ID (spaced by a comma).
terraform import elestio_maybe.my_maybe project_id,maybe_service_id
```
