...
page_title: "elestio_docspell Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Simple document organizerThe elestio_docspell resource allows the creation and management of Elestio Docspell services. The service uses the following docker image docspell/restserver https://hub.docker.com/r/docspell/restserver
---
...
```shell
# Import a Docspell service by specifying the Project ID it belongs to, and the Docspell service ID (spaced by a comma).
terraform import elestio_docspell.my_docspell project_id,docspell_service_id
```
