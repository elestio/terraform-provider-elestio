...
subcategory: ""
description: |-
  An open-source knowledge-based community software. You can use it quickly to build Q&A community for your products, customers, teams, and more.elestio_answer is a preconfigured elestio_service resource (template_id: 295) running Answer from the Docker image https://hub.docker.com/r/answerdev/answer answerdev/answer.
---
...
```shell
# Import a Answer service by specifying the Project ID it belongs to, and the Answer service ID (spaced by a comma).
terraform import elestio_answer.my_answer project_id,answer_service_id
```
