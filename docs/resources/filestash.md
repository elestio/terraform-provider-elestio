...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/filestash-7t74.png" width="100" height="100" /><br/> Filestash is a resource that creates a service with the `template_id = 131`. Filestash is a Dropbox-like file manager that lets you manage your data anywhere it is located.
