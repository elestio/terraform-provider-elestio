...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/logo-healthchecks-zDNH.svg" width="100" height="100" /><br/> Healthchecks is a resource that creates a service with the `template_id = 140`. Healthchecks is an online service for monitoring regularly running tasks such as cron jobs.
