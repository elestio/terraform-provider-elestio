...
page_title: "elestio_ojs Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open Journal Systems (OJS) is open-source software to manage scholarly journals.The elestio_ojs resource allows the creation and management of Elestio OJS services. The service uses the following docker image pkpofficial/ojs https://hub.docker.com/r/pkpofficial/ojs
---

# elestio_ojs (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Open-Journal-Systems-Xbcj.png" width="100" /><br>Open Journal Systems (OJS) is open-source software to manage scholarly journals.<br><br>The **elestio_ojs** resource allows the creation and management of Elestio OJS services. The service uses the following docker image [pkpofficial/ojs](https://hub.docker.com/r/pkpofficial/ojs)
...
```shell
# Import a OJS service by specifying the Project ID it belongs to, and the OJS service ID (spaced by a comma).
terraform import elestio_ojs.my_ojs project_id,ojs_service_id
```
