...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/odoo-logo-JAer.png" width="100" height="100" /><br/> Odoo ERP & CRM is a resource that creates a service with the `template_id = 86`. Odoo is a suite of web-based, open-source business apps.
