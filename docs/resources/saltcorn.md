...
page_title: "elestio_saltcorn Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Saltcorn is a platform for building applications without writing code.The elestio_saltcorn resource allows the creation and management of Elestio Saltcorn services. The service uses the following docker image saltcorn/saltcorn https://hub.docker.com/r/saltcorn/saltcorn
---

# elestio_saltcorn (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/saltcorn-emY2.png" width="100" /><br>Saltcorn is a platform for building applications without writing code.<br><br>The **elestio_saltcorn** resource allows the creation and management of Elestio Saltcorn services. The service uses the following docker image [saltcorn/saltcorn](https://hub.docker.com/r/saltcorn/saltcorn)
...
```shell
# Import a Saltcorn service by specifying the Project ID it belongs to, and the Saltcorn service ID (spaced by a comma).
terraform import elestio_saltcorn.my_saltcorn project_id,saltcorn_service_id
```
