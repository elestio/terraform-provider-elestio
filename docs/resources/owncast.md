...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Owncast-L0Gg.png" width="100" height="100" /><br/> Owncast is a resource that creates a service with the `template_id = 299`. Owncast is a free and open source live video and web chat server for use with existing popular broadcasting software.
