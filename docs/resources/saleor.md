...
```shell
# Import a Saleor service by specifying the Project ID it belongs to, and the Saleor service ID (spaced by a comma).
terraform import elestio_saleor.my_saleor project_id,saleor_service_id
```
