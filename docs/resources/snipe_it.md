...
page_title: "elestio_snipe_it Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  An IT asset/license management systemThe elestio_snipe_it resource allows the creation and management of Elestio Snipe-it services. The service uses the following docker image snipe/snipe-it https://hub.docker.com/r/snipe/snipe-it
---

# elestio_snipe_it (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/snipe-it-O4u1.png" width="100" /><br>An IT asset/license management system<br><br>The **elestio_snipe_it** resource allows the creation and management of Elestio Snipe-it services. The service uses the following docker image [snipe/snipe-it](https://hub.docker.com/r/snipe/snipe-it)
...
```shell
# Import a Snipe-it service by specifying the Project ID it belongs to, and the Snipe-it service ID (spaced by a comma).
terraform import elestio_snipe_it.my_snipe_it project_id,snipe_it_service_id
```
