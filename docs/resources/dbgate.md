...
page_title: "elestio_dbgate Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Database manager for MySQL, PostgreSQL, SQL Server, MongoDB, SQLite, and others. Runs under Windows, Linux, Mac, or as a web applicationThe elestio_dbgate resource allows the creation and management of Elestio DbGate services. The service uses the following docker image dbgate/dbgate https://hub.docker.com/r/dbgate/dbgate
---

# elestio_dbgate (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/DbGate-7IUm.png" width="100" /><br>Database manager for MySQL, PostgreSQL, SQL Server, MongoDB, SQLite, and others. Runs under Windows, Linux, Mac, or as a web application<br><br>The **elestio_dbgate** resource allows the creation and management of Elestio DbGate services. The service uses the following docker image [dbgate/dbgate](https://hub.docker.com/r/dbgate/dbgate)
...
```shell
# Import a DbGate service by specifying the Project ID it belongs to, and the DbGate service ID (spaced by a comma).
terraform import elestio_dbgate.my_dbgate project_id,dbgate_service_id
```
