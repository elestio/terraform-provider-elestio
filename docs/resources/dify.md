...
page_title: "elestio_dify Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features, and more, letting you quickly go from prototype to production.The elestio_dify resource allows the creation and management of Elestio Dify services. The service uses the following docker image langgenius/dify-web https://hub.docker.com/r/langgenius/dify-web
---

# elestio_dify (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Dify-pbrz.png" width="100" /><br>LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features, and more, letting you quickly go from prototype to production.<br><br>The **elestio_dify** resource allows the creation and management of Elestio Dify services. The service uses the following docker image [langgenius/dify-web](https://hub.docker.com/r/langgenius/dify-web)
...
- `version` (String) This is the version of the software used as service. **Default** `0.15.2`.
...
```shell
# Import a Dify service by specifying the Project ID it belongs to, and the Dify service ID (spaced by a comma).
terraform import elestio_dify.my_dify project_id,dify_service_id
```
