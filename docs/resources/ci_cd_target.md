...
subcategory: ""
description: |-
  Deploy one or multiple CD/CD pipelines to a target nodeelestiocicd_target is a preconfigured elestio_service resource (template_id: 234) running CI-CD-Target.
---

# elestio_ci_cd_target (Resource)

<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/CI-CD-Target2-YtKS.svg" width="100" height="100" /><br/> Deploy one or multiple CD/CD pipelines to a target node<br/><br/>**elestio_ci_cd_target** is a preconfigured elestio_service resource (`template_id: 234`) running **CI-CD-Target**.
...
```shell
# Import a CI-CD-Target service by specifying the Project ID it belongs to, and the CI-CD-Target service ID (spaced by a comma).
terraform import elestio_ci_cd_target.my_ci_cd_target project_id,ci_cd_target_service_id
```
