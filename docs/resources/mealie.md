...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Mealie-LZF8.png" width="100" height="100" /><br/> Mealie is a resource that creates a service with the `template_id = 292`. Mealie is an intuitive and easy to use recipe management app
