...
description: |-
  Mautic is a open source marketing automation software.The elestio_mautic resource allows the creation and management of Elestio Mautic services. The service uses the following docker image mautic/mautic https://hub.docker.com/r/mautic/mautic
---

# elestio_mautic (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Mautic-HOef.png" width="100" /><br>Mautic is a open source marketing automation software.<br><br>The **elestio_mautic** resource allows the creation and management of Elestio Mautic services. The service uses the following docker image [mautic/mautic](https://hub.docker.com/r/mautic/mautic)
...
- `version` (String) This is the version of the software used as service. **Default** `6.0.3-fpm`.
...
```shell
# Import a Mautic service by specifying the Project ID it belongs to, and the Mautic service ID (spaced by a comma).
terraform import elestio_mautic.my_mautic project_id,mautic_service_id
```
