...
subcategory: ""
description: |-
  Owncast is a free and open source live video and web chat server for use with existing popular broadcasting software.elestio_owncast is a preconfigured elestio_service resource (template_id: 299) running Owncast from the Docker image https://hub.docker.com/r/owncast/owncast owncast/owncast.
---

# elestio_owncast (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Owncast-L0Gg.png" width="100" /><br/> Owncast is a free and open source live video and web chat server for use with existing popular broadcasting software.<br/><br/>**elestio_owncast** is a preconfigured elestio_service resource (`template_id: 299`) running **Owncast** from the [Docker image](https://hub.docker.com/r/owncast/owncast) `owncast/owncast`.
...
```shell
# Import a Owncast service by specifying the Project ID it belongs to, and the Owncast service ID (spaced by a comma).
terraform import elestio_owncast.my_owncast project_id,owncast_service_id
```
