...
```shell
# Import a Huginn service by specifying the Project ID it belongs to, and the Huginn service ID (spaced by a comma).
terraform import elestio_huginn.my_huginn project_id,huginn_service_id
```
