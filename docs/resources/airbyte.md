...
description: |-
  Airbyte is an open-source data integration platform that syncs data from applications, APIs, and databases to warehousesThe elestio_airbyte resource allows the creation and management of Elestio Airbyte services. The service uses the following docker image airbyte/server https://hub.docker.com/r/airbyte/server
---
...
- `version` (String) This is the version of the software used as service. **Default** `0.50.30`.
