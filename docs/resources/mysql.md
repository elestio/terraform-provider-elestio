...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/287-2873694-mysql-logo-png-transparent-png-download--1--gmvZ.png" width="100" height="100" /><br/> MySQL is a resource that creates a service with the `template_id = 12`. MySQL is an Oracle-backed open-source RDBMS that runs on almost all platforms.
