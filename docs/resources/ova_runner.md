...
page_title: "elestio_ova_runner Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Run any OVA/VMDK/QCOW2 virtual machine image on Elestio using QEMU/KVM.The elestio_ova_runner resource allows the creation and management of Elestio OVA-Runner services. The service uses the following docker image debian https://hub.docker.com/r/debian
---

# elestio_ova_runner (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/OVA-runner-Je6o.png" width="100" /><br>Run any OVA/VMDK/QCOW2 virtual machine image on Elestio using QEMU/KVM.<br><br>The **elestio_ova_runner** resource allows the creation and management of Elestio OVA-Runner services. The service uses the following docker image [debian](https://hub.docker.com/r/debian)
...
- `version` (String) This is the version of the software used as service. **Default** `trixie-slim`.
...
```shell
# Import a OVA-Runner service by specifying the Project ID it belongs to, and the OVA-Runner service ID (spaced by a comma).
terraform import elestio_ova_runner.my_ova_runner project_id,ova_runner_service_id
```
