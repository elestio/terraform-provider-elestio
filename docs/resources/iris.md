...
```shell
# Import a IRIS service by specifying the Project ID it belongs to, and the IRIS service ID (spaced by a comma).
terraform import elestio_iris.my_iris project_id,iris_service_id
```
