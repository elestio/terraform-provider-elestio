...
page_title: "elestio_openrouteservice Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  The open-source route planner api with plenty of features.The elestio_openrouteservice resource allows the creation and management of Elestio Openrouteservice services. The service uses the following docker image openrouteservice/openrouteservice https://hub.docker.com/r/openrouteservice/openrouteservice
---

# elestio_openrouteservice (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Openrouteservice-Ug3k.png" width="100" /><br>The open-source route planner api with plenty of features.<br><br>The **elestio_openrouteservice** resource allows the creation and management of Elestio Openrouteservice services. The service uses the following docker image [openrouteservice/openrouteservice](https://hub.docker.com/r/openrouteservice/openrouteservice)
...
```shell
# Import a Openrouteservice service by specifying the Project ID it belongs to, and the Openrouteservice service ID (spaced by a comma).
terraform import elestio_openrouteservice.my_openrouteservice project_id,openrouteservice_service_id
```
