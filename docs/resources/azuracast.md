...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/AzuraCast-aDBt.png" width="100" height="100" /><br/> AzuraCast is a resource that creates a service with the `template_id = 222`. A self-hosted web radio management suite
