...
<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/node-red-logo-gbLk.png" width="100" height="100" /><br/> Node-red is a resource that creates a service with the `template_id = 55`. Node-RED is a low-code programming environment for event-driven applications.
