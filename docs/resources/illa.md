...
page_title: "elestio_illa Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  ILLA Cloud is a low-code platform. Anyone can build internal tools with ILLA Cloud in minutes.The elestio_illa resource allows the creation and management of Elestio ILLA services. The service uses the following docker image illasoft/illa-builder https://hub.docker.com/r/illasoft/illa-builder
---
...
```shell
# Import a ILLA service by specifying the Project ID it belongs to, and the ILLA service ID (spaced by a comma).
terraform import elestio_illa.my_illa project_id,illa_service_id
```
