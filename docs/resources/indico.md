...
page_title: "elestio_indico Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A feature-rich event management system, made @ CERN, the place where the Web was born.The elestio_indico resource allows the creation and management of Elestio Indico services. The service uses the following docker image elestio/indico https://hub.docker.com/r/elestio/indico
---

# elestio_indico (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Indico-wxdZ.png" width="100" /><br>A feature-rich event management system, made @ CERN, the place where the Web was born.<br><br>The **elestio_indico** resource allows the creation and management of Elestio Indico services. The service uses the following docker image [elestio/indico](https://hub.docker.com/r/elestio/indico)
...
```shell
# Import a Indico service by specifying the Project ID it belongs to, and the Indico service ID (spaced by a comma).
terraform import elestio_indico.my_indico project_id,indico_service_id
```
