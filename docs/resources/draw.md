...
page_title: "elestio_draw Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  draw.io is a JavaScript, client-side editor for general diagramming.The elestio_draw resource allows the creation and management of Elestio draw services. The service uses the following docker image jgraph/drawio https://hub.docker.com/r/jgraph/drawio
---

# elestio_draw (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/draw-n8ug.png" width="100" /><br>draw.io is a JavaScript, client-side editor for general diagramming.<br><br>The **elestio_draw** resource allows the creation and management of Elestio draw services. The service uses the following docker image [jgraph/drawio](https://hub.docker.com/r/jgraph/drawio)
...
```shell
# Import a draw service by specifying the Project ID it belongs to, and the draw service ID (spaced by a comma).
terraform import elestio_draw.my_draw project_id,draw_service_id
```
