...
subcategory: ""
description: |-
  SigNoz is an open-source APM solution for understanding issues in your applications and solving them quicklyelestio_signoz is a preconfigured elestio_service resource (template_id: 110) running SigNoz.
---

# elestio_signoz (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/signoz-8Mth.svg" width="100" /><br/> SigNoz is an open-source APM solution for understanding issues in your applications and solving them quickly<br/><br/>**elestio_signoz** is a preconfigured elestio_service resource (`template_id: 110`) running **SigNoz**.
...
```shell
# Import a SigNoz service by specifying the Project ID it belongs to, and the SigNoz service ID (spaced by a comma).
terraform import elestio_signoz.my_signoz project_id,signoz_service_id
```
