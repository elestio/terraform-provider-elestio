...
```shell
# Import a OpenClaw service by specifying the Project ID it belongs to, and the OpenClaw service ID (spaced by a comma).
terraform import elestio_openclaw.my_openclaw project_id,openclaw_service_id
```
