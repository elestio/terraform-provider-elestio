...
description: |-
  The definitive self-hosted URL shortenerThe elestio_shlink resource allows the creation and management of Elestio Shlink services. The service uses the following docker image shlinkio/shlink https://hub.docker.com/r/shlinkio/shlink
---
