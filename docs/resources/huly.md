...
page_title: "elestio_huly Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  All-in-One Project Management Platform (alternative to Linear, Jira, Slack, Notion, Motion)The elestio_huly resource allows the creation and management of Elestio Huly services. The service uses the following docker image hardcoreeng/front https://hub.docker.com/r/hardcoreeng/front
---

# elestio_huly (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Huly-wXad.png" width="100" /><br>All-in-One Project Management Platform (alternative to Linear, Jira, Slack, Notion, Motion)<br><br>The **elestio_huly** resource allows the creation and management of Elestio Huly services. The service uses the following docker image [hardcoreeng/front](https://hub.docker.com/r/hardcoreeng/front)
...
- `version` (String) This is the version of the software used as service. **Default** `v0.6.228a`.
...
```shell
# Import a Huly service by specifying the Project ID it belongs to, and the Huly service ID (spaced by a comma).
terraform import elestio_huly.my_huly project_id,huly_service_id
```
