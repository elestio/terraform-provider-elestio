...
description: |-
  The free artifact repository with universal format support.The elestio_nexus3 resource allows the creation and management of Elestio Nexus3 services. The service uses the following docker image sonatype/nexus3 https://hub.docker.com/r/sonatype/nexus3
---
...
```shell
# Import a Nexus3 service by specifying the Project ID it belongs to, and the Nexus3 service ID (spaced by a comma).
terraform import elestio_nexus3.my_nexus3 project_id,nexus3_service_id
```
