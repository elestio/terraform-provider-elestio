...
description: |-
  Imagor is a fast, Docker-ready image processing server.The elestio_imagor resource allows the creation and management of Elestio Imagor services. The service uses the following docker image shumc/imagor https://hub.docker.com/r/shumc/imagor
---
