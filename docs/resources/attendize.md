...
page_title: "elestio_attendize Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Attendize is a ticket-selling and event management platform.The elestio_attendize resource allows the creation and management of Elestio Attendize services. The service uses the following docker image elestio/attendize-web https://hub.docker.com/r/elestio/attendize-web
---

# elestio_attendize (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Attendize-eyaN.png" width="100" /><br>Attendize is a ticket-selling and event management platform.<br><br>The **elestio_attendize** resource allows the creation and management of Elestio Attendize services. The service uses the following docker image [elestio/attendize-web](https://hub.docker.com/r/elestio/attendize-web)
...
```shell
# Import a Attendize service by specifying the Project ID it belongs to, and the Attendize service ID (spaced by a comma).
terraform import elestio_attendize.my_attendize project_id,attendize_service_id
```
