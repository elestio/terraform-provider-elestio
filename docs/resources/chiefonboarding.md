...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/151832141493-657c97eadff523414184-512-removebg-preview-EuP8.png" width="100" height="100" /><br/> ChiefOnboarding is a resource that creates a service with the `template_id = 291`. Create entire blueprints of what your new hire will go through within minutes. Simply drag and drop items into the timeline.
