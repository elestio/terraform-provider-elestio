...
page_title: "elestio_tolgee Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open-source developer & translator friendly localization platform 🐁The elestio_tolgee resource allows the creation and management of Elestio Tolgee services. The service uses the following docker image tolgee/tolgee https://hub.docker.com/r/tolgee/tolgee
---

# elestio_tolgee (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/tolgee-kqnI.png" width="100" /><br>Open-source developer & translator friendly localization platform 🐁<br><br>The **elestio_tolgee** resource allows the creation and management of Elestio Tolgee services. The service uses the following docker image [tolgee/tolgee](https://hub.docker.com/r/tolgee/tolgee)
...
```shell
# Import a Tolgee service by specifying the Project ID it belongs to, and the Tolgee service ID (spaced by a comma).
terraform import elestio_tolgee.my_tolgee project_id,tolgee_service_id
```
