...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/trudesk-gzOA.png" width="100" height="100" /><br/> Trudesk is a resource that creates a service with the `template_id = 271`. Trudesk is an open-source help desk/ticketing solution.
