...
page_title: "elestio_pretix Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Ticket shop application for conferences, festivals, concerts, tech events, shows, exhibitions, workshops, bar camps, etc.The elestio_pretix resource allows the creation and management of Elestio Pretix services. The service uses the following docker image pretix/standalone https://hub.docker.com/r/pretix/standalone
---

# elestio_pretix (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Pretix-o0gZ.png" width="100" /><br>Ticket shop application for conferences, festivals, concerts, tech events, shows, exhibitions, workshops, bar camps, etc.<br><br>The **elestio_pretix** resource allows the creation and management of Elestio Pretix services. The service uses the following docker image [pretix/standalone](https://hub.docker.com/r/pretix/standalone)
...
```shell
# Import a Pretix service by specifying the Project ID it belongs to, and the Pretix service ID (spaced by a comma).
terraform import elestio_pretix.my_pretix project_id,pretix_service_id
```
