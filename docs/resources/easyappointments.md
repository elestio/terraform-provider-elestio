...
page_title: "elestio_easyappointments Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open Source Appointment Scheduler that allows customers to book appointments with youThe elestio_easyappointments resource allows the creation and management of Elestio EasyAppointments services. The service uses the following docker image alextselegidis/easyappointments https://hub.docker.com/r/alextselegidis/easyappointments
---

# elestio_easyappointments (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/EasyAppointments-JAnU.png" width="100" /><br>Open Source Appointment Scheduler that allows customers to book appointments with you<br><br>The **elestio_easyappointments** resource allows the creation and management of Elestio EasyAppointments services. The service uses the following docker image [alextselegidis/easyappointments](https://hub.docker.com/r/alextselegidis/easyappointments)
...
- `version` (String) This is the version of the software used as service. **Default** `1.4.3`.
...
```shell
# Import a EasyAppointments service by specifying the Project ID it belongs to, and the EasyAppointments service ID (spaced by a comma).
terraform import elestio_easyappointments.my_easyappointments project_id,easyappointments_service_id
```
