...
```shell
# Import a Qdrant service by specifying the Project ID it belongs to, and the Qdrant service ID (spaced by a comma).
terraform import elestio_qdrant.my_qdrant project_id,qdrant_service_id
```
