...
page_title: "elestio_ghostfolio Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open Source Wealth Management Software. It's a privacy-first dashboard for your personal finances. Break down your asset allocation, know your net worth, and make solid, data-driven investment decisions.The elestio_ghostfolio resource allows the creation and management of Elestio Ghostfolio services. The service uses the following docker image ghostfolio/ghostfolio https://hub.docker.com/r/ghostfolio/ghostfolio
---

# elestio_ghostfolio (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Ghostfolio-DGJc.png" width="100" /><br>Open Source Wealth Management Software. It's a privacy-first dashboard for your personal finances. Break down your asset allocation, know your net worth, and make solid, data-driven investment decisions.<br><br>The **elestio_ghostfolio** resource allows the creation and management of Elestio Ghostfolio services. The service uses the following docker image [ghostfolio/ghostfolio](https://hub.docker.com/r/ghostfolio/ghostfolio)
...
```shell
# Import a Ghostfolio service by specifying the Project ID it belongs to, and the Ghostfolio service ID (spaced by a comma).
terraform import elestio_ghostfolio.my_ghostfolio project_id,ghostfolio_service_id
```
