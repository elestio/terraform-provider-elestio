...
page_title: "elestio_serpbear Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  SerpBear is an Open Source Search Engine Position Tracking App. It allows you to track your website's keyword positions in Google and get notified of their positions.The elestio_serpbear resource allows the creation and management of Elestio SerpBear services. The service uses the following docker image towfiqi/serpbear https://hub.docker.com/r/towfiqi/serpbear
---
...
```shell
# Import a SerpBear service by specifying the Project ID it belongs to, and the SerpBear service ID (spaced by a comma).
terraform import elestio_serpbear.my_serpbear project_id,serpbear_service_id
```
