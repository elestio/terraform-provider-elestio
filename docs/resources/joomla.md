...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Joomla--Logo-CiYs.png" width="100" height="100" /><br/> Joomla is a resource that creates a service with the `template_id = 97`. Joomla is an award-winning content management system for building websites and powerful online applications.
