...
subcategory: ""
description: |-
  The definitive self-hosted URL shortenerelestio_shlink is a preconfigured elestioservice resource (template_id: 239) running Shlink ([`dockerimage: shlinkio/shlink`](https://hub.docker.com/r/shlinkio/shlink)).
---
