...
description: |-
  Project & Task Management for Software Development TeamsThe elestio_focalboard resource allows the creation and management of Elestio FocalBoard services. The service uses the following docker image mattermost/focalboard https://hub.docker.com/r/mattermost/focalboard
---
