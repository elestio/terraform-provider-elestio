...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/synclogo-text-128-vnSG.png" width="100" height="100" /><br/> Syncthing is a resource that creates a service with the `template_id = 123`. Syncthing is a free, continuous, multiple-device file synchronization program.
