...
page_title: "elestio_streamlit Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  A faster way to build and share data apps.The elestio_streamlit resource allows the creation and management of Elestio Streamlit services. The service uses the following docker image streamlit https://hub.docker.com/r/streamlit
---

# elestio_streamlit (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Streamlit-CLDl.png" width="100" /><br>A faster way to build and share data apps.<br><br>The **elestio_streamlit** resource allows the creation and management of Elestio Streamlit services. The service uses the following docker image [streamlit](https://hub.docker.com/r/streamlit)
...
```shell
# Import a Streamlit service by specifying the Project ID it belongs to, and the Streamlit service ID (spaced by a comma).
terraform import elestio_streamlit.my_streamlit project_id,streamlit_service_id
```
