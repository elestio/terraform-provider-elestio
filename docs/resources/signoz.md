...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/signoz-8Mth.svg" width="100" height="100" /><br/> SigNoz is a resource that creates a service with the `template_id = 110`. SigNoz is an open-source APM solution for understanding issues in your applications and solving them quickly
