...
subcategory: ""
description: |-
  Create your community based on Matrix protocolelestio_element is a preconfigured elestio_service resource (template_id: 248) running Element from the Docker image https://hub.docker.com/r/matrixdotorg/synapse matrixdotorg/synapse.
---

# elestio_element (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Element-rC1j.png" width="100" /><br/> Create your community based on Matrix protocol<br/><br/>**elestio_element** is a preconfigured elestio_service resource (`template_id: 248`) running **Element** from the [Docker image](https://hub.docker.com/r/matrixdotorg/synapse) `matrixdotorg/synapse`.
...
```shell
# Import a Element service by specifying the Project ID it belongs to, and the Element service ID (spaced by a comma).
terraform import elestio_element.my_element project_id,element_service_id
```
