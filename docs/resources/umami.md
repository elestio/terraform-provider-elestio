...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/umami-yKdl.png" width="100" height="100" /><br/> Umami is a resource that creates a service with the `template_id = 188`. Umami is a simple, fast, website analytics alternative to Google Analytics.
