...
subcategory: ""
description: |-
  Debian (aka Debian GNU/Linux) is a Linux distribution composed of free and open-source software.elestio_debian is a preconfigured elestio_service resource (template_id: 36) running Debian.
---
