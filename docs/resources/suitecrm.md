...
subcategory: ""
description: |-
  SuiteCRM is an open source Customer Relationship Management (CRM) software solution that provides a 360-degree view of your customers and business.elestio_suitecrm is a preconfigured elestio_service resource (template_id: 277) running SuiteCRM from the Docker image https://hub.docker.com/r/docker.io/bitnami/suitecrm docker.io/bitnami/suitecrm.
---
