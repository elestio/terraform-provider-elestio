...
```shell
# Import a ComfyUI service by specifying the Project ID it belongs to, and the ComfyUI service ID (spaced by a comma).
terraform import elestio_comfyui.my_comfyui project_id,comfyui_service_id
```
