...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/DockerRegistry-XOni.png" width="100" height="100" /><br/> DockerRegistry is a resource that creates a service with the `template_id = 230`. Docker Registry is a stateless, highly scalable server side application that stores and lets you distribute Docker images. The Registry is open-source, under the permissive Apache license.
