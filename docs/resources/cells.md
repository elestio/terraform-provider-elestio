...
page_title: "elestio_cells Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Pydio Cells is the Document Sharing, Management, and Collaboration platform.The elestio_cells resource allows the creation and management of Elestio Cells services. The service uses the following docker image elestio/cells https://hub.docker.com/r/elestio/cells
---

# elestio_cells (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Cells-h7xC.png" width="100" /><br>Pydio Cells is the Document Sharing, Management, and Collaboration platform.<br><br>The **elestio_cells** resource allows the creation and management of Elestio Cells services. The service uses the following docker image [elestio/cells](https://hub.docker.com/r/elestio/cells)
...
```shell
# Import a Cells service by specifying the Project ID it belongs to, and the Cells service ID (spaced by a comma).
terraform import elestio_cells.my_cells project_id,cells_service_id
```
