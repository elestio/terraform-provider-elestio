...
page_title: "elestio_wger Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  FLOSS fitness/workout, nutrition and weight trackerThe elestio_wger resource allows the creation and management of Elestio Wger services. The service uses the following docker image wger/server https://hub.docker.com/r/wger/server
---

# elestio_wger (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Wger-xM1O.png" width="100" /><br>FLOSS fitness/workout, nutrition and weight tracker<br><br>The **elestio_wger** resource allows the creation and management of Elestio Wger services. The service uses the following docker image [wger/server](https://hub.docker.com/r/wger/server)
...
```shell
# Import a Wger service by specifying the Project ID it belongs to, and the Wger service ID (spaced by a comma).
terraform import elestio_wger.my_wger project_id,wger_service_id
```
