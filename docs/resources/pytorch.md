...
```shell
# Import a PyTorch service by specifying the Project ID it belongs to, and the PyTorch service ID (spaced by a comma).
terraform import elestio_pytorch.my_pytorch project_id,pytorch_service_id
```
