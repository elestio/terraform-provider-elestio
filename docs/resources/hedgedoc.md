...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/HedgeDoc-VR31.png" width="100" height="100" /><br/> HedgeDoc is a resource that creates a service with the `template_id = 243`. HedgeDoc is an open-source, web-based, self-hosted, collaborative markdown editor
