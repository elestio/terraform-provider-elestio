...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/airflow-logo--1--edli.png" width="100" height="100" /><br/> Airflow is a resource that creates a service with the `template_id = 249`. Airflow is a platform created by the community to programmatically author, schedule and monitor workflows.
