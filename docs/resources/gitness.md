...
page_title: "elestio_gitness Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Gitness is an Open Source developer platform with Source Control Management, Continuous Integration, and Continuous Delivery.The elestio_gitness resource allows the creation and management of Elestio Gitness services. The service uses the following docker image elestio/gitness https://hub.docker.com/r/elestio/gitness
---

# elestio_gitness (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Gitness-ntkL.png" width="100" /><br>Gitness is an Open Source developer platform with Source Control Management, Continuous Integration, and Continuous Delivery.<br><br>The **elestio_gitness** resource allows the creation and management of Elestio Gitness services. The service uses the following docker image [elestio/gitness](https://hub.docker.com/r/elestio/gitness)
...
```shell
# Import a Gitness service by specifying the Project ID it belongs to, and the Gitness service ID (spaced by a comma).
terraform import elestio_gitness.my_gitness project_id,gitness_service_id
```
