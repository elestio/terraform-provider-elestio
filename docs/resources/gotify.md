...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/gotify-6mZO.png" width="100" height="100" /><br/> Gotify is a resource that creates a service with the `template_id = 146`. Gotify is a free and simple server for sending and receiving messages.
