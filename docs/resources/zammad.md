...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/zammad-EmPz.png" width="100" height="100" /><br/> Zammad is a resource that creates a service with the `template_id = 106`. Zammad is a web-based, open-source helpdesk/customer support system.
