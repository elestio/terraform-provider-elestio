...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/appsmith-DJZg.png" width="100" height="100" /><br/> Appsmith is a resource that creates a service with the `template_id = 125`.  Appsmith is a powerful open-source framework to build internal tools.
