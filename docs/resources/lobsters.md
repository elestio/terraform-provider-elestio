...
```shell
# Import a Lobsters service by specifying the Project ID it belongs to, and the Lobsters service ID (spaced by a comma).
terraform import elestio_lobsters.my_lobsters project_id,lobsters_service_id
```
