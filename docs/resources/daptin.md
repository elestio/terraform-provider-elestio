...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/daptin-EyiZ.png" width="100" height="100" /><br/> Daptin is a resource that creates a service with the `template_id = 139`. Daptin is a powerful data and services API server.
