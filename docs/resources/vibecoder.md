...
page_title: "elestio_vibecoder Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  VibeCoder by Elestio—Instantly code, deploy, and go live with zero config, zero DevOps, and full Claude power.The elestio_vibecoder resource allows the creation and management of Elestio Vibecoder services. The service uses the following docker image elestio/vibecoder https://hub.docker.com/r/elestio/vibecoder
---

# elestio_vibecoder (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/vibecoder-icon-jjVe.png" width="100" /><br>VibeCoder by Elestio—Instantly code, deploy, and go live with zero config, zero DevOps, and full Claude power.<br><br>The **elestio_vibecoder** resource allows the creation and management of Elestio Vibecoder services. The service uses the following docker image [elestio/vibecoder](https://hub.docker.com/r/elestio/vibecoder)
...
```shell
# Import a Vibecoder service by specifying the Project ID it belongs to, and the Vibecoder service ID (spaced by a comma).
terraform import elestio_vibecoder.my_vibecoder project_id,vibecoder_service_id
```
