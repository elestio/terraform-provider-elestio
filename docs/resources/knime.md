...
```shell
# Import a Knime service by specifying the Project ID it belongs to, and the Knime service ID (spaced by a comma).
terraform import elestio_knime.my_knime project_id,knime_service_id
```
