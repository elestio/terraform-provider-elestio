...
```shell
# Import a M3DB service by specifying the Project ID it belongs to, and the M3DB service ID (spaced by a comma).
terraform import elestio_m3db.my_m3db project_id,m3db_service_id
```
