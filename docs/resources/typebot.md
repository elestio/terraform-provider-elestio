...
```shell
# Import a Typebot service by specifying the Project ID it belongs to, and the Typebot service ID (spaced by a comma).
terraform import elestio_typebot.my_typebot project_id,typebot_service_id
```
