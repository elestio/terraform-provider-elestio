...
page_title: "elestio_jellyfin Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Free Software Media System that puts you in control of managing and streaming your media alternative to the proprietary Emby and Plex.The elestio_jellyfin resource allows the creation and management of Elestio Jellyfin services. The service uses the following docker image jellyfin/jellyfin https://hub.docker.com/r/jellyfin/jellyfin
---

# elestio_jellyfin (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Jellyfin-Ki1R.png" width="100" /><br>Free Software Media System that puts you in control of managing and streaming your media alternative to the proprietary Emby and Plex.<br><br>The **elestio_jellyfin** resource allows the creation and management of Elestio Jellyfin services. The service uses the following docker image [jellyfin/jellyfin](https://hub.docker.com/r/jellyfin/jellyfin)
...
```shell
# Import a Jellyfin service by specifying the Project ID it belongs to, and the Jellyfin service ID (spaced by a comma).
terraform import elestio_jellyfin.my_jellyfin project_id,jellyfin_service_id
```
