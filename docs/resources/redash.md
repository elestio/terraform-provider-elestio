...
page_title: "elestio_redash Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Make Your Company Data Driven. Connect to any data source, easily visualize, dashboard and share your data.The elestio_redash resource allows the creation and management of Elestio Redash services. The service uses the following docker image redash/redash https://hub.docker.com/r/redash/redash
---

# elestio_redash (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Redash-i65M.png" width="100" /><br>Make Your Company Data Driven. Connect to any data source, easily visualize, dashboard and share your data.<br><br>The **elestio_redash** resource allows the creation and management of Elestio Redash services. The service uses the following docker image [redash/redash](https://hub.docker.com/r/redash/redash)
...
- `version` (String) This is the version of the software used as service. **Default** `25.1.0`.
...
```shell
# Import a Redash service by specifying the Project ID it belongs to, and the Redash service ID (spaced by a comma).
terraform import elestio_redash.my_redash project_id,redash_service_id
```
