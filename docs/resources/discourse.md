...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/kisspng-logo-discourse-internet-forum-brand-font-discourse-5b68ee610214d6-m4FJ.png" width="100" height="100" /><br/> Discourse is a resource that creates a service with the `template_id = 91`. Discourse is an open-source discussion platform built for the next decade of the Internet.
