...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Mastodon-nT8w.png" width="100" height="100" /><br/> Mastodon is a resource that creates a service with the `template_id = 229`. Mastodon is a free, open-source social network server
