...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Grafana-MDph.png" width="100" height="100" /><br/> Grafana is a resource that creates a service with the `template_id = 79`. Grafana is a multi-platform, open-source analytics and interactive visualization web application.
