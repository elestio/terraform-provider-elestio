...
page_title: "elestio_opnform Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Form Builder, Create beautiful forms and share them anywhere. It is super fast, you don't need to know how to code. It's an alternative to products like Typeform, JotForm, Tally, etcThe elestio_opnform resource allows the creation and management of Elestio OpnForm services. The service uses the following docker image elestio/opnform https://hub.docker.com/r/elestio/opnform
---

# elestio_opnform (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/OpnForm-wNN2.png" width="100" /><br>Form Builder, Create beautiful forms and share them anywhere. It is super fast, you don't need to know how to code. It's an alternative to products like Typeform, JotForm, Tally, etc<br><br>The **elestio_opnform** resource allows the creation and management of Elestio OpnForm services. The service uses the following docker image [elestio/opnform](https://hub.docker.com/r/elestio/opnform)
...
```shell
# Import a OpnForm service by specifying the Project ID it belongs to, and the OpnForm service ID (spaced by a comma).
terraform import elestio_opnform.my_opnform project_id,opnform_service_id
```
