...
page_title: "elestio_omeka Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A flexible web publishing platform for the display of library, museum, and scholarly collections, archives, and exhibitions.The elestio_omeka resource allows the creation and management of Elestio Omeka services. The service uses the following docker image elestio/omeka https://hub.docker.com/r/elestio/omeka
---

# elestio_omeka (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Omeka-m9t1.png" width="100" /><br>A flexible web publishing platform for the display of library, museum, and scholarly collections, archives, and exhibitions.<br><br>The **elestio_omeka** resource allows the creation and management of Elestio Omeka services. The service uses the following docker image [elestio/omeka](https://hub.docker.com/r/elestio/omeka)
...
```shell
# Import a Omeka service by specifying the Project ID it belongs to, and the Omeka service ID (spaced by a comma).
terraform import elestio_omeka.my_omeka project_id,omeka_service_id
```
