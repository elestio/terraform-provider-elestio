...
```shell
# Import a Taiga service by specifying the Project ID it belongs to, and the Taiga service ID (spaced by a comma).
terraform import elestio_taiga.my_taiga project_id,taiga_service_id
```
