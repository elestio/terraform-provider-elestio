...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/SFTPGo-VvLZ.png" width="100" height="100" /><br/> SFTPGo is a resource that creates a service with the `template_id = 260`. Fully featured and highly configurable SFTP server with optional HTTP/S, FTP/S and WebDAV support
