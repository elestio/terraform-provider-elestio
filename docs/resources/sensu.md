...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Sensu-H3Of.png" width="100" height="100" /><br/> Sensu is a resource that creates a service with the `template_id = 211`. Sensu is an open source monitoring tool for ephemeral infrastructure and distributed applications.
