...
page_title: "elestio_metabasepostgres Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Metabase is an open-source tool that simply and quickly gathers business intelligence and analytics for your company.The elestio_metabasepostgres resource allows the creation and management of Elestio MetabasePostgres services. The service uses the following docker image metabase/metabase https://hub.docker.com/r/metabase/metabase
---
...
```shell
# Import a MetabasePostgres service by specifying the Project ID it belongs to, and the MetabasePostgres service ID (spaced by a comma).
terraform import elestio_metabasepostgres.my_metabasepostgres project_id,metabasepostgres_service_id
```
