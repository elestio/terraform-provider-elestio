...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/k3s-BF91.png" width="100" height="100" /><br/> K3S is a resource that creates a service with the `template_id = 179`. K3s is a fully compliant Kubernetes distribution
