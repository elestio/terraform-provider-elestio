...
page_title: "elestio_kbin Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A reddit-like content aggregator and micro-blogging platform for the fediverse.The elestio_kbin resource allows the creation and management of Elestio KBIN services. The service uses the following docker image elestio/kbin https://hub.docker.com/r/elestio/kbin
---
...
```shell
# Import a KBIN service by specifying the Project ID it belongs to, and the KBIN service ID (spaced by a comma).
terraform import elestio_kbin.my_kbin project_id,kbin_service_id
```
