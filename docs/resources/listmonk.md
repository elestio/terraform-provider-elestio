...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Listmonk-Fcfg.png" width="100" height="100" /><br/> Listmonk is a resource that creates a service with the `template_id = 237`. Listmonk is a self-hosted, high performance mailing list and newsletter manager
