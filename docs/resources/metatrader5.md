...
description: |-
  Trade on Forex & stock markets in a virtual desktop from your browserThe elestio_metatrader5 resource allows the creation and management of Elestio MetaTrader5 services. The service uses the following docker image elestio/ubuntu-desktop https://hub.docker.com/r/elestio/ubuntu-desktop
---
...
```shell
# Import a MetaTrader5 service by specifying the Project ID it belongs to, and the MetaTrader5 service ID (spaced by a comma).
terraform import elestio_metatrader5.my_metatrader5 project_id,metatrader5_service_id
```
