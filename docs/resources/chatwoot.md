...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/brand-d6ec4f18194acc9e590c511b9ae51974-7fgU.svg" width="100" height="100" /><br/> Chatwoot is an open-source, alternative customer engagement suite.<br/><br/>**elestio_chatwoot** is a preconfigured elestio_service resource (`template_id: 84`) running **Chatwoot** ([`docker_image: chatwoot/chatwoot`](https://hub.docker.com/r/chatwoot/chatwoot)).
...
```shell
# Import a Chatwoot service by specifying the Project ID it belongs to, and the Chatwoot service ID (spaced by a comma).
terraform import elestio_chatwoot.my_chatwoot project_id,chatwoot_service_id
```
