...
page_title: "elestio_kroki Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Creates diagrams from textual descriptions!The elestio_kroki resource allows the creation and management of Elestio Kroki services. The service uses the following docker image yuzutech/kroki https://hub.docker.com/r/yuzutech/kroki
---

# elestio_kroki (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Kroki-0iSM.png" width="100" /><br>Creates diagrams from textual descriptions!<br><br>The **elestio_kroki** resource allows the creation and management of Elestio Kroki services. The service uses the following docker image [yuzutech/kroki](https://hub.docker.com/r/yuzutech/kroki)
...
```shell
# Import a Kroki service by specifying the Project ID it belongs to, and the Kroki service ID (spaced by a comma).
terraform import elestio_kroki.my_kroki project_id,kroki_service_id
```
