...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/onlyoffice-BiCl.png" width="100" height="100" /><br/> OnlyOffice is a resource that creates a service with the `template_id = 109`. OnlyOffice is a free, online office suite comprising viewers and editors for texts, spreadsheets and presentations.
