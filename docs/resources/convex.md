...
```shell
# Import a Convex service by specifying the Project ID it belongs to, and the Convex service ID (spaced by a comma).
terraform import elestio_convex.my_convex project_id,convex_service_id
```
