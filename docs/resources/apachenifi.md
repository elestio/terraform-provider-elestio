...
page_title: "elestio_apachenifi Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Apache NiFi automates the movement of data between disparate data sources and systems, making data ingestion fast, easy, and secure.The elestio_apachenifi resource allows the creation and management of Elestio ApacheNiFi services. The service uses the following docker image apache/nifi https://hub.docker.com/r/apache/nifi
---
...
```shell
# Import a ApacheNiFi service by specifying the Project ID it belongs to, and the ApacheNiFi service ID (spaced by a comma).
terraform import elestio_apachenifi.my_apachenifi project_id,apachenifi_service_id
```
