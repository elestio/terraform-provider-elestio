...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/CryptPad-ayFU.png" width="100" height="100" /><br/> CryptPad is a resource that creates a service with the `template_id = 194`. CryptPad is a collaboration suite, encrypted and open-source.
