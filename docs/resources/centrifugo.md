...
description: |-
  Centrifugo is a scalable real-time, language-agnostic messaging server. The elestio_centrifugo resource allows the creation and management of Elestio Centrifugo services. The service uses the following docker image centrifugo/centrifugo https://hub.docker.com/r/centrifugo/centrifugo
---
