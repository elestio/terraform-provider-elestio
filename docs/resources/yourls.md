...
page_title: "elestio_yourls Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  YOURLS (Your Own URL Shortener), de facto standard self-hosted URL shortener in PHPThe elestio_yourls resource allows the creation and management of Elestio YOURLS services. The service uses the following docker image yourls https://hub.docker.com/r/yourls
---

# elestio_yourls (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/YOURLS-IyjD.png" width="100" /><br>YOURLS (Your Own URL Shortener), de facto standard self-hosted URL shortener in PHP<br><br>The **elestio_yourls** resource allows the creation and management of Elestio YOURLS services. The service uses the following docker image [yourls](https://hub.docker.com/r/yourls)
...
```shell
# Import a YOURLS service by specifying the Project ID it belongs to, and the YOURLS service ID (spaced by a comma).
terraform import elestio_yourls.my_yourls project_id,yourls_service_id
```
