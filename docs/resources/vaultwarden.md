...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/vaultwarden-logo-pzQm.svg" width="100" height="100" /><br/> Vaultwarden is a resource that creates a service with the `template_id = 66`.  Vaultwarden is an open-source password management application that can be self-hosted and run on your infrastructure.
