...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/freescout-icon-zdui0h5vwn6vq9af-c-A0pH.png" width="100" height="100" /><br/> FreeScout is a resource that creates a service with the `template_id = 193`. FreeScout is a free self-hosted help desk & shared mailbox.
