...
page_title: "elestio_peppermint Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  An open source ticket management & help desk solution. A zendesk/freshdesk alternativeThe elestio_peppermint resource allows the creation and management of Elestio Peppermint services. The service uses the following docker image elestio/peppermint https://hub.docker.com/r/elestio/peppermint
---

# elestio_peppermint (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Peppermint-qgpz.png" width="100" /><br>An open source ticket management & help desk solution. A zendesk/freshdesk alternative<br><br>The **elestio_peppermint** resource allows the creation and management of Elestio Peppermint services. The service uses the following docker image [elestio/peppermint](https://hub.docker.com/r/elestio/peppermint)
...
```shell
# Import a Peppermint service by specifying the Project ID it belongs to, and the Peppermint service ID (spaced by a comma).
terraform import elestio_peppermint.my_peppermint project_id,peppermint_service_id
```
