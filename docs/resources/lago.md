...
```shell
# Import a Lago service by specifying the Project ID it belongs to, and the Lago service ID (spaced by a comma).
terraform import elestio_lago.my_lago project_id,lago_service_id
```
