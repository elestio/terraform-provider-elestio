...
page_title: "elestio_chaskiq Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A full-featured Live Chat, Support, and marketing platform, an alternative to Intercom, Drift, Crisp, etcThe elestio_chaskiq resource allows the creation and management of Elestio Chaskiq services. The service uses the following docker image chaskiq/chaskiq https://hub.docker.com/r/chaskiq/chaskiq
---
...
```shell
# Import a Chaskiq service by specifying the Project ID it belongs to, and the Chaskiq service ID (spaced by a comma).
terraform import elestio_chaskiq.my_chaskiq project_id,chaskiq_service_id
```
