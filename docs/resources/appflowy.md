...
page_title: "elestio_appflowy Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Bring projects, wikis, and teams together with AI. AppFlowy is an AI collaborative workspace where you achieve more without losing control of your data. The best open source alternative to Notion.The elestio_appflowy resource allows the creation and management of Elestio AppFlowy services. The service uses the following docker image appflowyinc/appflowy_cloud https://hub.docker.com/r/appflowyinc/appflowy_cloud
---

# elestio_appflowy (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/AppFlowy-1W8h.png" width="100" /><br>Bring projects, wikis, and teams together with AI. AppFlowy is an AI collaborative workspace where you achieve more without losing control of your data. The best open source alternative to Notion.<br><br>The **elestio_appflowy** resource allows the creation and management of Elestio AppFlowy services. The service uses the following docker image [appflowyinc/appflowy_cloud](https://hub.docker.com/r/appflowyinc/appflowy_cloud)
...
```shell
# Import a AppFlowy service by specifying the Project ID it belongs to, and the AppFlowy service ID (spaced by a comma).
terraform import elestio_appflowy.my_appflowy project_id,appflowy_service_id
```
