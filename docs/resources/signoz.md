...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/signoz-8Mth.svg" width="100" height="100" /><br/> SigNoz is an open-source APM solution for understanding issues in your applications and solving them quickly<br/><br/>**elestio_signoz** is a preconfigured elestio_service resource (`template_id: 110`) running **SigNoz**.
