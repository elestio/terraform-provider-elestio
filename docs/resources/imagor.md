...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/imagor-wsHT.png" width="100" height="100" /><br/> Imagor is a resource that creates a service with the `template_id = 203`. Imagor is a fast, Docker-ready image processing server.
