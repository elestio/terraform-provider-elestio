...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/fugu-KvzW.png" width="100" height="100" /><br/> Fugu is a resource that creates a service with the `template_id = 216`. Fugu is a product analytics software with a strong focus on simplicity and privacy-friendliness.
