...
page_title: "elestio_outline Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Outline is a fast wiki and knowledge base for growing teams - an alternative to Google Docs. The elestio_outline resource allows the creation and management of Elestio Outline services. The service uses the following docker image outlinewiki/outline https://hub.docker.com/r/outlinewiki/outline
---
...
```shell
# Import a Outline service by specifying the Project ID it belongs to, and the Outline service ID (spaced by a comma).
terraform import elestio_outline.my_outline project_id,outline_service_id
```
