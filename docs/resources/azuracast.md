...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/AzuraCast-aDBt.png" width="100" height="100" /><br/> A self-hosted web radio management suite<br/><br/>**elestio_azuracast** is a preconfigured elestio_service resource (`template_id: 222`) running **AzuraCast** ([`docker_image: azuracast/azuracast`](https://hub.docker.com/r/azuracast/azuracast)).
