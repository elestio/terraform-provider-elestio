...
page_title: "elestio_funkwhale Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A modern, convivial, and free music audio and podcasts server on YunoHostThe elestio_funkwhale resource allows the creation and management of Elestio Funkwhale services. The service uses the following docker image funkwhale/api https://hub.docker.com/r/funkwhale/api
---

# elestio_funkwhale (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/funkwhale-tPMI.png" width="100" /><br>A modern, convivial, and free music audio and podcasts server on YunoHost<br><br>The **elestio_funkwhale** resource allows the creation and management of Elestio Funkwhale services. The service uses the following docker image [funkwhale/api](https://hub.docker.com/r/funkwhale/api)
...
```shell
# Import a Funkwhale service by specifying the Project ID it belongs to, and the Funkwhale service ID (spaced by a comma).
terraform import elestio_funkwhale.my_funkwhale project_id,funkwhale_service_id
```
