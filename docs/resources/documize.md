...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/documize-icon-StjS.png" width="100" height="100" /><br/> Documize is a resource that creates a service with the `template_id = 279`. Free Knowledge Management Software
