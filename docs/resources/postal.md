...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/postal-QwYV.svg" width="100" height="100" /><br/> Postal is a resource that creates a service with the `template_id = 132`. Postal is a fully featured open-source mail delivery platform for incoming and outgoing email.
