...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/wireguard2-sk98.jpg" width="100" height="100" /><br/> WG-Easy is a resource that creates a service with the `template_id = 177`. WireGuard is a simple, fast general-purpose VPN for running on embedded interfaces and super computers alike.
