...
description: |-
  Create your community based on Matrix protocolThe elestio_element resource allows the creation and management of Elestio Element services. The service uses the following docker image matrixdotorg/synapse https://hub.docker.com/r/matrixdotorg/synapse
---
