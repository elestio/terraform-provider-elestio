...
```shell
# Import a Coroot service by specifying the Project ID it belongs to, and the Coroot service ID (spaced by a comma).
terraform import elestio_coroot.my_coroot project_id,coroot_service_id
```
