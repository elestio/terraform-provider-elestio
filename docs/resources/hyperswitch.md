...
page_title: "elestio_hyperswitch Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  An open-source payments switch written in Rust to make payments fast, reliable, and affordable.The elestio_hyperswitch resource allows the creation and management of Elestio Hyperswitch services. The service uses the following docker image juspaydotin/hyperswitch-producer https://hub.docker.com/r/juspaydotin/hyperswitch-producer
---

# elestio_hyperswitch (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Hyperswitch-p0yE.png" width="100" /><br>An open-source payments switch written in Rust to make payments fast, reliable, and affordable.<br><br>The **elestio_hyperswitch** resource allows the creation and management of Elestio Hyperswitch services. The service uses the following docker image [juspaydotin/hyperswitch-producer](https://hub.docker.com/r/juspaydotin/hyperswitch-producer)
...
- `version` (String) This is the version of the software used as service. **Default** `standalone`.
...
```shell
# Import a Hyperswitch service by specifying the Project ID it belongs to, and the Hyperswitch service ID (spaced by a comma).
terraform import elestio_hyperswitch.my_hyperswitch project_id,hyperswitch_service_id
```
