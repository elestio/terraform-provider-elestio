...
page_title: "elestio_passit Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Password manager to use on any device with a web browser to secure your digital life.The elestio_passit resource allows the creation and management of Elestio Passit services. The service uses the following docker image passit/passit https://hub.docker.com/r/passit/passit
---

# elestio_passit (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Passit-BKah.png" width="100" /><br>Password manager to use on any device with a web browser to secure your digital life.<br><br>The **elestio_passit** resource allows the creation and management of Elestio Passit services. The service uses the following docker image [passit/passit](https://hub.docker.com/r/passit/passit)
...
```shell
# Import a Passit service by specifying the Project ID it belongs to, and the Passit service ID (spaced by a comma).
terraform import elestio_passit.my_passit project_id,passit_service_id
```
