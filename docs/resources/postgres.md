...
subcategory: ""
description: |-
  PostgreSQL is a resource that creates a service with the template_id = 11.
---

# elestio_postgres (Resource)

<img src="" width="100" height="100" /><br/> PostgreSQL is a resource that creates a service with the `template_id = 11`.
