...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/1280px-Redis-Logo-8Xj9.png" width="100" height="100" /><br/> Redis is a resource that creates a service with the `template_id = 3`. Redis is an open-source, in-memory database, cache and message broker.
