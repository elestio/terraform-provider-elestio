...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/mediaCMS-kXpX.jpg" width="100" height="100" /><br/> MediaCMS is a resource that creates a service with the `template_id = 175`. MediaCMS is a fully featured open-source video and media CMS.
