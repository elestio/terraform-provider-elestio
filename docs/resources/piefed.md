...
page_title: "elestio_piefed Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Lemmy/Mbin alternative written in Python with FlaskThe elestio_piefed resource allows the creation and management of Elestio PieFed services. The service uses the following docker image elestio/piefed https://hub.docker.com/r/elestio/piefed
---

# elestio_piefed (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/PieFed-CBYD.png" width="100" /><br>Lemmy/Mbin alternative written in Python with Flask<br><br>The **elestio_piefed** resource allows the creation and management of Elestio PieFed services. The service uses the following docker image [elestio/piefed](https://hub.docker.com/r/elestio/piefed)
...
```shell
# Import a PieFed service by specifying the Project ID it belongs to, and the PieFed service ID (spaced by a comma).
terraform import elestio_piefed.my_piefed project_id,piefed_service_id
```
