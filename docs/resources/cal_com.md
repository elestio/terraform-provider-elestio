...
```shell
# Import a Cal.com service by specifying the Project ID it belongs to, and the Cal.com service ID (spaced by a comma).
terraform import elestio_cal_com.my_cal_com project_id,cal_com_service_id
```
