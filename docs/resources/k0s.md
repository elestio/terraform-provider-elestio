...
subcategory: ""
description: |-
  The Simple, Solid & Certified Kubernetes Distribution. Deploy and run Kubernetes workloads at any scale on any infrastructure. All batteries included. 100% open source & free.elestio_k0s is a preconfigured elestio_service resource (template_id: 214) running k0s.
---
