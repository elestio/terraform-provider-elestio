...
page_title: "elestio_gorules Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Open-source Business Rules Engine for your Rust, NodeJS, Python, or Go applications.The elestio_gorules resource allows the creation and management of Elestio GoRules services. The service uses the following docker image gorules/brms https://hub.docker.com/r/gorules/brms
---

# elestio_gorules (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/GoRules-j7MV.png" width="100" /><br>Open-source Business Rules Engine for your Rust, NodeJS, Python, or Go applications.<br><br>The **elestio_gorules** resource allows the creation and management of Elestio GoRules services. The service uses the following docker image [gorules/brms](https://hub.docker.com/r/gorules/brms)
...
```shell
# Import a GoRules service by specifying the Project ID it belongs to, and the GoRules service ID (spaced by a comma).
terraform import elestio_gorules.my_gorules project_id,gorules_service_id
```
