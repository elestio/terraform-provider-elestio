...
<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/qrfrajefv1o01zv8nfju-removebg-preview-ZJtv.png" width="100" height="100" /><br/> Wikijs is a resource that creates a service with the `template_id = 58`. Wikijs is a powerful open-source wiki app built on Node.js, Git and Markdown.
