...
<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/logo--8--TgNO.png" width="100" height="100" /><br/> Ghost is a resource that creates a service with the `template_id = 49`. Ghost is a powerful app for new-media creators to publish, share, and grow a business around their content.
