...
subcategory: ""
description: |-
  Couchbase Resource is a preconfigured Service Resource with the template_id = 302. Couchbase Server is a modern cloud-native, distributed database that fuses the strengths of relational databases such as SQL and ACID transactions with JSON flexibility and scale that defines NoSQL Docker hub image: couchbase https://hub.docker.com/r/couchbase
---

# elestio_couchbase (Resource)

Couchbase Resource is a preconfigured Service Resource with the `template_id = 302`.<br/><br/><img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Couchbase-4ECx.png" width="100" height="100" /><br/> Couchbase Server is a modern cloud-native, distributed database that fuses the strengths of relational databases such as SQL and ACID transactions with JSON flexibility and scale that defines NoSQL<br/><br/> Docker hub image: [`couchbase`](https://hub.docker.com/r/couchbase)
