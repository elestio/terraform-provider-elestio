...
<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/bookstack--1--KwEn.png" width="100" height="100" /><br/> BookStack is a platform to create documentation/wiki content built with PHP & Laravel.<br/><br/>**elestio_bookstack** is a preconfigured elestio_service resource (`template_id: 143`) running **BookStack** ([`docker_image: linuxserver/bookstack`](https://hub.docker.com/r/linuxserver/bookstack)).
