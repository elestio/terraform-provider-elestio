...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Influxdb-logo-Ear0.png" width="100" height="100" /><br/> InfluxDB is a resource that creates a service with the `template_id = 116`. InfluxDB is a scalable datastore that empowers developers to build IoT, analytics and monitoring software.
