...
subcategory: ""
description: |-
  Invoice Ninja is the leading free, open-source online invoicing app for freelancers and businesses. elestio_invoiceninja is a preconfigured elestioservice resource (template_id: 152) running InvoiceNinja ([`dockerimage: invoiceninja/invoiceninja`](https://hub.docker.com/r/invoiceninja/invoiceninja)).
---
