...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/huginn-Jd5i.png" width="100" height="100" /><br/> Huginn is a resource that creates a service with the `template_id = 202`. Huginn is a tool in the Web Service Automation category of a tech stack.
