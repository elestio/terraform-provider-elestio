...
page_title: "elestio_wazuh Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  The Open Source Security Platform. Unified XDR and SIEM protection for endpoints and cloud workloads.The elestio_wazuh resource allows the creation and management of Elestio Wazuh services. The service uses the following docker image wazuh/wazuh-manager https://hub.docker.com/r/wazuh/wazuh-manager
---

# elestio_wazuh (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Wazuh-izYv.png" width="100" /><br>The Open Source Security Platform. Unified XDR and SIEM protection for endpoints and cloud workloads.<br><br>The **elestio_wazuh** resource allows the creation and management of Elestio Wazuh services. The service uses the following docker image [wazuh/wazuh-manager](https://hub.docker.com/r/wazuh/wazuh-manager)
...
- `version` (String) This is the version of the software used as service. **Default** `4.13.1`.
...
```shell
# Import a Wazuh service by specifying the Project ID it belongs to, and the Wazuh service ID (spaced by a comma).
terraform import elestio_wazuh.my_wazuh project_id,wazuh_service_id
```
