...
```shell
# Import a Hop service by specifying the Project ID it belongs to, and the Hop service ID (spaced by a comma).
terraform import elestio_hop.my_hop project_id,hop_service_id
```
