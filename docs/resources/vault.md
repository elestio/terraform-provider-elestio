...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/vault-ttul.png" width="100" height="100" /><br/> Vault is a resource that creates a service with the `template_id = 183`. Vault is a tool for secrets management, encryption as a service, and privileged access management
