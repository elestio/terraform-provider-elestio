...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Element-rC1j.png" width="100" height="100" /><br/> Element is a resource that creates a service with the `template_id = 248`. Create your community based on Matrix protocol
