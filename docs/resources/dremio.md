...
```shell
# Import a Dremio service by specifying the Project ID it belongs to, and the Dremio service ID (spaced by a comma).
terraform import elestio_dremio.my_dremio project_id,dremio_service_id
```
