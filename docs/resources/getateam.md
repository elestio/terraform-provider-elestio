...
page_title: "elestio_getateam Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  Hire AI Employees That Actually WorkThe elestio_getateam resource allows the creation and management of Elestio GetATeam services. The service uses the following docker image elestio/getateam https://hub.docker.com/r/elestio/getateam
---

# elestio_getateam (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/GAT-3lMB.png" width="100" /><br>Hire AI Employees That Actually Work<br><br>The **elestio_getateam** resource allows the creation and management of Elestio GetATeam services. The service uses the following docker image [elestio/getateam](https://hub.docker.com/r/elestio/getateam)
...
```shell
# Import a GetATeam service by specifying the Project ID it belongs to, and the GetATeam service ID (spaced by a comma).
terraform import elestio_getateam.my_getateam project_id,getateam_service_id
```
