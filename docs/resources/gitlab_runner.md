...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Gitlab-qKSS.png" width="100" height="100" /><br/> Gitlab-runner is a resource that creates a service with the `template_id = 235`. GitLab Runner is an application that works with GitLab CI/CD to run jobs in a pipeline.
