...
page_title: "elestio_surrealdb Resource - terraform-provider-elestio"
subcategory: "Services: Databases & Cache"
description: |-
  A scalable, distributed, collaborative, document-graph database, for the realtime web.The elestio_surrealdb resource allows the creation and management of Elestio SurrealDB services. The service uses the following docker image surrealdb/surrealdb https://hub.docker.com/r/surrealdb/surrealdb
---

# elestio_surrealdb (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/SurrealDB-mXIy.png" width="100" /><br>A scalable, distributed, collaborative, document-graph database, for the realtime web.<br><br>The **elestio_surrealdb** resource allows the creation and management of Elestio SurrealDB services. The service uses the following docker image [surrealdb/surrealdb](https://hub.docker.com/r/surrealdb/surrealdb)
...
```shell
# Import a SurrealDB service by specifying the Project ID it belongs to, and the SurrealDB service ID (spaced by a comma).
terraform import elestio_surrealdb.my_surrealdb project_id,surrealdb_service_id
```
