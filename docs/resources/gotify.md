...
description: |-
  Gotify is a free and simple server for sending and receiving messages.The elestio_gotify resource allows the creation and management of Elestio Gotify services. The service uses the following docker image gotify/server https://hub.docker.com/r/gotify/server
---
