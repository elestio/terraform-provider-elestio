...
description: |-
  KeeWeb is a free, open-source password manager, available as a web version and as a desktop app. The elestio_keeweb resource allows the creation and management of Elestio KeeWeb services. The service uses the following docker image antelle/keeweb https://hub.docker.com/r/antelle/keeweb
---
