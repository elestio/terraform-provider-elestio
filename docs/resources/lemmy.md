...
page_title: "elestio_lemmy Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open-source Reddit alternative. Create your own discussion platform with LemmyThe elestio_lemmy resource allows the creation and management of Elestio Lemmy services. The service uses the following docker image dessalines/lemmy https://hub.docker.com/r/dessalines/lemmy
---
...
- `version` (String) This is the version of the software used as service. **Default** `0.19.4`.
...
```shell
# Import a Lemmy service by specifying the Project ID it belongs to, and the Lemmy service ID (spaced by a comma).
terraform import elestio_lemmy.my_lemmy project_id,lemmy_service_id
```
