...
page_title: "elestio_wordpress_multisites Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  WordPress Multisite is a version of WordPress that allows you to run multiple sites off a single installation of WordPress.The elestio_wordpress_multisites resource allows the creation and management of Elestio Wordpress-Multisites services. The service uses the following docker image elestio/wordpress https://hub.docker.com/r/elestio/wordpress
---

# elestio_wordpress_multisites (Resource)

<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/800px-WordPress-logo-4TuK.png" width="100" /><br>WordPress Multisite is a version of WordPress that allows you to run multiple sites off a single installation of WordPress.<br><br>The **elestio_wordpress_multisites** resource allows the creation and management of Elestio Wordpress-Multisites services. The service uses the following docker image [elestio/wordpress](https://hub.docker.com/r/elestio/wordpress)
...
```shell
# Import a Wordpress-Multisites service by specifying the Project ID it belongs to, and the Wordpress-Multisites service ID (spaced by a comma).
terraform import elestio_wordpress_multisites.my_wordpress_multisites project_id,wordpress_multisites_service_id
```
