...
page_title: "elestio_bugsink Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Self-hosted Error TrackingThe elestio_bugsink resource allows the creation and management of Elestio Bugsink services. The service uses the following docker image bugsink/bugsink https://hub.docker.com/r/bugsink/bugsink
---

# elestio_bugsink (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Bugsink-IWBd.png" width="100" /><br>Self-hosted Error Tracking<br><br>The **elestio_bugsink** resource allows the creation and management of Elestio Bugsink services. The service uses the following docker image [bugsink/bugsink](https://hub.docker.com/r/bugsink/bugsink)
...
```shell
# Import a Bugsink service by specifying the Project ID it belongs to, and the Bugsink service ID (spaced by a comma).
terraform import elestio_bugsink.my_bugsink project_id,bugsink_service_id
```
