...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/InvoiceNinja-logo-220x90-J8W0.png" width="100" height="100" /><br/> InvoiceNinja is a resource that creates a service with the `template_id = 152`. Invoice Ninja is the leading free, open-source online invoicing app for freelancers and businesses.
