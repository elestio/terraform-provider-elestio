...
page_title: "elestio_logto Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Logto is an Auth0 alternative for building modern customer identity infrastructure with minimal effort, for both your customers and their organizations.The elestio_logto resource allows the creation and management of Elestio Logto services. The service uses the following docker image svhd/logto https://hub.docker.com/r/svhd/logto
---

# elestio_logto (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Logto-E0P0.png" width="100" /><br>Logto is an Auth0 alternative for building modern customer identity infrastructure with minimal effort, for both your customers and their organizations.<br><br>The **elestio_logto** resource allows the creation and management of Elestio Logto services. The service uses the following docker image [svhd/logto](https://hub.docker.com/r/svhd/logto)
...
```shell
# Import a Logto service by specifying the Project ID it belongs to, and the Logto service ID (spaced by a comma).
terraform import elestio_logto.my_logto project_id,logto_service_id
```
