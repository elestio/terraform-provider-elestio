...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Apache-Guacamole-logo--1--TZJP.png" width="100" height="100" /><br/> Guacamole is a resource that creates a service with the `template_id = 142`. Apache Guacamole is a clientless remote desktop gateway.
