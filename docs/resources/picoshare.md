...
page_title: "elestio_picoshare Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  PicoShare is a service for sharing images, videos, and other files.The elestio_picoshare resource allows the creation and management of Elestio Picoshare services. The service uses the following docker image mtlynch/picoshare https://hub.docker.com/r/mtlynch/picoshare
---
...
```shell
# Import a Picoshare service by specifying the Project ID it belongs to, and the Picoshare service ID (spaced by a comma).
terraform import elestio_picoshare.my_picoshare project_id,picoshare_service_id
```
