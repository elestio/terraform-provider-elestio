...
page_title: "elestio_docmost Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Docmost is a collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.The elestio_docmost resource allows the creation and management of Elestio Docmost services. The service uses the following docker image docmost/docmost https://hub.docker.com/r/docmost/docmost
---

# elestio_docmost (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Docmost-RfCr.png" width="100" /><br>Docmost is a collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.<br><br>The **elestio_docmost** resource allows the creation and management of Elestio Docmost services. The service uses the following docker image [docmost/docmost](https://hub.docker.com/r/docmost/docmost)
...
```shell
# Import a Docmost service by specifying the Project ID it belongs to, and the Docmost service ID (spaced by a comma).
terraform import elestio_docmost.my_docmost project_id,docmost_service_id
```
