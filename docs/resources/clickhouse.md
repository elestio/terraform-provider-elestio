...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/clickhouse-WFqc.png" width="100" height="100" /><br/> ClickHouse is a resource that creates a service with the `template_id = 93`. ClickHouse is an open-source, column-oriented DBMS for online analytical processing.
