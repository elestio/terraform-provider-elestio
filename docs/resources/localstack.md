...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Localstack-YeZh.png" width="100" height="100" /><br/> LocalStack is a resource that creates a service with the `template_id = 275`. A fully functional local cloud stack. Develop and test your cloud and serverless apps offline!
