...
page_title: "elestio_jibri Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Jibri provides services for recording or streaming a Jitsi Meet conference.The elestio_jibri resource allows the creation and management of Elestio Jibri services. The service uses the following docker image jitsi/jibri https://hub.docker.com/r/jitsi/jibri
---

# elestio_jibri (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/jitsimeet-ZZbj.png" width="100" /><br>Jibri provides services for recording or streaming a Jitsi Meet conference.<br><br>The **elestio_jibri** resource allows the creation and management of Elestio Jibri services. The service uses the following docker image [jitsi/jibri](https://hub.docker.com/r/jitsi/jibri)
...
```shell
# Import a Jibri service by specifying the Project ID it belongs to, and the Jibri service ID (spaced by a comma).
terraform import elestio_jibri.my_jibri project_id,jibri_service_id
```
