...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/rabbitmq-282296-dxOz.png" width="100" height="100" /><br/> RabbitMQ is a resource that creates a service with the `template_id = 212`. RabbitMQ is the most widely deployed open source message broker
