...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/gogs-HYw4.png" width="100" height="100" /><br/> Gogs is a resource that creates a service with the `template_id = 154`. Gogs is a lightweight self-hosted Git server that can be run on just about anything.
