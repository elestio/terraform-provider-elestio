...
```shell
# Import a Zep service by specifying the Project ID it belongs to, and the Zep service ID (spaced by a comma).
terraform import elestio_zep.my_zep project_id,zep_service_id
```
