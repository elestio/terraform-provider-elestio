...
page_title: "elestio_rallly Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Rallly is the Doodle alternative scheduling and collaboration tool designed to make organizing events and meetings easier.The elestio_rallly resource allows the creation and management of Elestio Rallly services. The service uses the following docker image lukevella/rallly https://hub.docker.com/r/lukevella/rallly
---
...
```shell
# Import a Rallly service by specifying the Project ID it belongs to, and the Rallly service ID (spaced by a comma).
terraform import elestio_rallly.my_rallly project_id,rallly_service_id
```
