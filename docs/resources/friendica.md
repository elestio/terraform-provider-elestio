...
page_title: "elestio_friendica Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A Decentralized Social Network, you can use to host your own social media server that forms one part of the fediverse, an interconnected and decentralized network of independently operated serversThe elestio_friendica resource allows the creation and management of Elestio Friendica services. The service uses the following docker image friendica https://hub.docker.com/r/friendica
---
...
- `version` (String) This is the version of the software used as service. **Default** `2023.05`.
...
```shell
# Import a Friendica service by specifying the Project ID it belongs to, and the Friendica service ID (spaced by a comma).
terraform import elestio_friendica.my_friendica project_id,friendica_service_id
```
