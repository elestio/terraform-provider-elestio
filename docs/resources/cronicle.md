...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Cronicle-GxiP.png" width="100" height="100" /><br/> Cronicle is a resource that creates a service with the `template_id = 206`. Cronicle is a simple, distributed task scheduler and runner with a web based UI.
