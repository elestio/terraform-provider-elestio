...
page_title: "elestio_freshrss Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  FreshRSS is an RSS and Atom feed aggregator.The elestio_freshrss resource allows the creation and management of Elestio FreshRSS services. The service uses the following docker image freshrss/freshrss https://hub.docker.com/r/freshrss/freshrss
---

# elestio_freshrss (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/FreshRSS-SZcX.png" width="100" /><br>FreshRSS is an RSS and Atom feed aggregator.<br><br>The **elestio_freshrss** resource allows the creation and management of Elestio FreshRSS services. The service uses the following docker image [freshrss/freshrss](https://hub.docker.com/r/freshrss/freshrss)
...
```shell
# Import a FreshRSS service by specifying the Project ID it belongs to, and the FreshRSS service ID (spaced by a comma).
terraform import elestio_freshrss.my_freshrss project_id,freshrss_service_id
```
