...
<img src="https://cf.appdrag.com/cloud-vm-c72afa/uploads/portainer-M5O2.png" width="100" height="100" /><br/> Portainer is a resource that creates a service with the `template_id = 53`. Portainer is a centralized service delivery platform for containerized apps.
