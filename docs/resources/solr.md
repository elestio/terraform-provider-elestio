...
subcategory: ""
description: |-
  Solr is the popular, blazing fast open source search platform for all your enterprise, e-commerce, and analytics needs, built on Apache Lucene.elestio_solr is a preconfigured elestioservice resource (template_id: 300) running Solr ([`dockerimage: bitnami/solr`](https://hub.docker.com/r/bitnami/solr)).
---
