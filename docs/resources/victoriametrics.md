...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/victoriametrics-aNTf.png" width="100" height="100" /><br/> VictoriaMetrics is a resource that creates a service with the `template_id = 156`. VictoriaMetrics is a fast, cost-effective monitoring solution and time series database
