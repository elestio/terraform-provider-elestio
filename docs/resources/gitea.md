...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/480px-Gitea-Logo-k3Mq.png" width="100" height="100" /><br/> Gitea is a resource that creates a service with the `template_id = 155`. Gitea is a painless self-hosted Git service. It is similar to GitHub, Bitbucket, and GitLab
