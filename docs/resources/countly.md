...
page_title: "elestio_countly Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Countly is a product analytics platform that helps teams track, analyze, and act on their user actions and behavior on mobile, web, and desktop applications.The elestio_countly resource allows the creation and management of Elestio Countly services. The service uses the following docker image countly/frontend https://hub.docker.com/r/countly/frontend
---

# elestio_countly (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Countly-gqmp.png" width="100" /><br>Countly is a product analytics platform that helps teams track, analyze, and act on their user actions and behavior on mobile, web, and desktop applications.<br><br>The **elestio_countly** resource allows the creation and management of Elestio Countly services. The service uses the following docker image [countly/frontend](https://hub.docker.com/r/countly/frontend)
...
```shell
# Import a Countly service by specifying the Project ID it belongs to, and the Countly service ID (spaced by a comma).
terraform import elestio_countly.my_countly project_id,countly_service_id
```
