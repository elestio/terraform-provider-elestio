...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/mapzy-logo--1--8BYM.png" width="100" height="100" /><br/> Mapzy is a resource that creates a service with the `template_id = 226`. A simple, self-hostable store finder that cares about your privacy.
