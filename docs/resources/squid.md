...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Squid-IXDg.png" width="100" height="100" /><br/> Squid is a resource that creates a service with the `template_id = 261`. Fast & powerful proxy server
