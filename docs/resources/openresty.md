...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/OpenResty-HC6K.png" width="100" height="100" /><br/> OpenResty is a resource that creates a service with the `template_id = 218`. A Fast and Scalable Web Platform by Extending NGINX with LuaJIT
