...
page_title: "elestio_kener Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Stunning status pages, batteries included!The elestio_kener resource allows the creation and management of Elestio Kener services. The service uses the following docker image rajnandan1/kener https://hub.docker.com/r/rajnandan1/kener
---

# elestio_kener (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Kener-TAYB.png" width="100" /><br>Stunning status pages, batteries included!<br><br>The **elestio_kener** resource allows the creation and management of Elestio Kener services. The service uses the following docker image [rajnandan1/kener](https://hub.docker.com/r/rajnandan1/kener)
...
```shell
# Import a Kener service by specifying the Project ID it belongs to, and the Kener service ID (spaced by a comma).
terraform import elestio_kener.my_kener project_id,kener_service_id
```
