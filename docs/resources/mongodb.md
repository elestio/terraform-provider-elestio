...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/2560px-MongoDB-Logo-XOCy.png" width="100" height="100" /><br/> MongoDB is a resource that creates a service with the `template_id = 19`. MongoDB is a document-oriented NoSQL database used for high-volume data storage.
