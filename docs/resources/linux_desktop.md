...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/LinuxDesktop-Mq0d.png" width="100" height="100" /><br/> Linux-desktop is a resource that creates a service with the `template_id = 236`. Linux Desktop in the browser. Install any linux app and run it in the browser.
