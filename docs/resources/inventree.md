...
page_title: "elestio_inventree Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Inventory management system which provides intuitive parts management and stock control.The elestio_inventree resource allows the creation and management of Elestio InvenTree services. The service uses the following docker image inventree/inventree https://hub.docker.com/r/inventree/inventree
---

# elestio_inventree (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/InvenTree-tGNf.png" width="100" /><br>Inventory management system which provides intuitive parts management and stock control.<br><br>The **elestio_inventree** resource allows the creation and management of Elestio InvenTree services. The service uses the following docker image [inventree/inventree](https://hub.docker.com/r/inventree/inventree)
...
```shell
# Import a InvenTree service by specifying the Project ID it belongs to, and the InvenTree service ID (spaced by a comma).
terraform import elestio_inventree.my_inventree project_id,inventree_service_id
```
