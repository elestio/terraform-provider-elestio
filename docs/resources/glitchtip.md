...
page_title: "elestio_glitchtip Resource - terraform-provider-elestio"
subcategory: "Services: Hosting & Infra"
description: |-
  Reimplementation of the Sentry error tracking platform, Track errors, uptime, and performance.The elestio_glitchtip resource allows the creation and management of Elestio GlitchTip services. The service uses the following docker image glitchtip/glitchtip https://hub.docker.com/r/glitchtip/glitchtip
---

# elestio_glitchtip (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/GlitchTip-6NZ6.png" width="100" /><br>Reimplementation of the Sentry error tracking platform, Track errors, uptime, and performance.<br><br>The **elestio_glitchtip** resource allows the creation and management of Elestio GlitchTip services. The service uses the following docker image [glitchtip/glitchtip](https://hub.docker.com/r/glitchtip/glitchtip)
...
```shell
# Import a GlitchTip service by specifying the Project ID it belongs to, and the GlitchTip service ID (spaced by a comma).
terraform import elestio_glitchtip.my_glitchtip project_id,glitchtip_service_id
```
