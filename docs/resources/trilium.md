...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Trilium-0jCA.png" width="100" height="100" /><br/> Trilium is a resource that creates a service with the `template_id = 293`. Trilium Notes is a hierarchical note taking application with focus on building large personal knowledge bases.
