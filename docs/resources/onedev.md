...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/onedev-kb7k.png" width="100" height="100" /><br/> Onedev is a resource that creates a service with the `template_id = 126`. OneDev is an open-source all-in-one DevOps platform.
