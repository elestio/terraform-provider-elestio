...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/nomad-logo-B6lr.png" width="100" height="100" /><br/> Nomad is a resource that creates a service with the `template_id = 170`. Nomad is a scheduler and workload orchestrator.
