...
subcategory: ""
description: |-
  Etherpad is a highly customizable open source online editor providing collaborative editing in really real-time.elestio_etherpad is a preconfigured elestioservice resource (template_id: 266) running Etherpad ([`dockerimage: etherpad/etherpad`](https://hub.docker.com/r/etherpad/etherpad)).
---
