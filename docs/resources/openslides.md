...
page_title: "elestio_openslides Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  OpenSlides is a powerful and modern, web-based software for the digital organization of your meetings and committees. The elestio_openslides resource allows the creation and management of Elestio OpenSlides services. The service uses the following docker image penslides/openslides/openslides-client https://hub.docker.com/r/penslides/openslides/openslides-client
---
...
```shell
# Import a OpenSlides service by specifying the Project ID it belongs to, and the OpenSlides service ID (spaced by a comma).
terraform import elestio_openslides.my_openslides project_id,openslides_service_id
```
