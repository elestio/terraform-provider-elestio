...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/iTop-icon-XPfe.png" width="100" height="100" /><br/> iTop is a resource that creates a service with the `template_id = 264`. iTop adapts to the needs of digital businesses to manage multiple customers, contracts and SLAs
