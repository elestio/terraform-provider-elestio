...
```shell
# Import a LiteLLM service by specifying the Project ID it belongs to, and the LiteLLM service ID (spaced by a comma).
terraform import elestio_litellm.my_litellm project_id,litellm_service_id
```
