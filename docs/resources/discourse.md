...
description: |-
  Discourse is an open-source discussion platform built for the next decade of the Internet. The elestio_discourse resource allows the creation and management of Elestio Discourse services. The service uses the following docker image bitnami/discourse https://hub.docker.com/r/bitnami/discourse
---
