...
description: |-
  NodeBB is next-generation forum software - powerful, mobile-ready and easy to use.The elestio_nodebb resource allows the creation and management of Elestio NodeBB services. The service uses the following docker image elestio/nodebb https://hub.docker.com/r/elestio/nodebb
---
