...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/penpot-PdtW.png" width="100" height="100" /><br/> Penpot is a resource that creates a service with the `template_id = 121`. Penpot is the first open-source design and prototyping platform for cross-domain teams.
