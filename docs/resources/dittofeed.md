...
page_title: "elestio_dittofeed Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Automate communications with customers. Give data control to your growth engineers.The elestio_dittofeed resource allows the creation and management of Elestio Dittofeed services. The service uses the following docker image dittofeed/dittofeed-dashboard https://hub.docker.com/r/dittofeed/dittofeed-dashboard
---
...
- `version` (String) This is the version of the software used as service. **Default** `v0.13.10`.
...
```shell
# Import a Dittofeed service by specifying the Project ID it belongs to, and the Dittofeed service ID (spaced by a comma).
terraform import elestio_dittofeed.my_dittofeed project_id,dittofeed_service_id
```
