...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Etherpad-vw2l.png" width="100" height="100" /><br/> Etherpad is a resource that creates a service with the `template_id = 266`. Etherpad is a highly customizable open source online editor providing collaborative editing in really real-time.
