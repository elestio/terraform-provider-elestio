...
```shell
# Import a Postiz service by specifying the Project ID it belongs to, and the Postiz service ID (spaced by a comma).
terraform import elestio_postiz.my_postiz project_id,postiz_service_id
```
