...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Nagios-xrco.png" width="100" height="100" /><br/> Nagios is a resource that creates a service with the `template_id = 254`. The Industry Standard In IT Infrastructure Monitoring
