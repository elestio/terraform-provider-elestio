...
page_title: "elestio_gophish Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A powerful phishing framework that makes it easy to test your organization's exposure to phishing.The elestio_gophish resource allows the creation and management of Elestio Gophish services. The service uses the following docker image gophish/gophish https://hub.docker.com/r/gophish/gophish
---

# elestio_gophish (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Gophish-7B8J.png" width="100" /><br>A powerful phishing framework that makes it easy to test your organization's exposure to phishing.<br><br>The **elestio_gophish** resource allows the creation and management of Elestio Gophish services. The service uses the following docker image [gophish/gophish](https://hub.docker.com/r/gophish/gophish)
...
```shell
# Import a Gophish service by specifying the Project ID it belongs to, and the Gophish service ID (spaced by a comma).
terraform import elestio_gophish.my_gophish project_id,gophish_service_id
```
