...
description: |-
  Typesense is a fast, typo-tolerant, fuzzy search engine for building great search experiences.The elestio_typesense resource allows the creation and management of Elestio Typesense services. The service uses the following docker image typesense/typesense https://hub.docker.com/r/typesense/typesense
---
