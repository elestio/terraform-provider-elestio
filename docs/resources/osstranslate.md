...
page_title: "elestio_osstranslate Resource - terraform-provider-elestio"
subcategory: "Services: Development"
description: |-
  Free and Open Source Machine Translation API. The elestio_osstranslate resource allows the creation and management of Elestio OSSTranslate services. The service uses the following docker image libretranslate/libretranslate https://hub.docker.com/r/libretranslate/libretranslate
---

# elestio_osstranslate (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/OSSTranslate-i3rM.png" width="100" /><br>Free and Open Source Machine Translation API. <br><br>The **elestio_osstranslate** resource allows the creation and management of Elestio OSSTranslate services. The service uses the following docker image [libretranslate/libretranslate](https://hub.docker.com/r/libretranslate/libretranslate)
...
```shell
# Import a OSSTranslate service by specifying the Project ID it belongs to, and the OSSTranslate service ID (spaced by a comma).
terraform import elestio_osstranslate.my_osstranslate project_id,osstranslate_service_id
```
