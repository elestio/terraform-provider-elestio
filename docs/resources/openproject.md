...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/openproject-logo-ccbb591e-TXxN.png" width="100" height="100" /><br/> OpenProject is a resource that creates a service with the `template_id = 118`. OpenProject is a web-based project management system for location-independent team collaboration.
