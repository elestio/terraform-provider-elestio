...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/G2mNnDi-PoW0.png" width="100" height="100" /><br/> NodeBB is a resource that creates a service with the `template_id = 90`. NodeBB is next-generation forum software - powerful, mobile-ready and easy to use.
