...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/1200px-Joplin-icon-rZ5H.png" width="100" height="100" /><br/> Joplin is a resource that creates a service with the `template_id = 200`. Joplin - an open source note taking and to-do application with synchronization capabilities for Windows, macOS, Linux, Android and iOS
