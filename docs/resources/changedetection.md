...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/changedetection-MGUw.png" width="100" height="100" /><br/> ChangeDetection is a resource that creates a service with the `template_id = 186`. Changedetection.io is an open source web page monitoring, notification and change detection.
