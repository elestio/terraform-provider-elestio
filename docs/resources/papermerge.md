...
page_title: "elestio_papermerge Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  Open Source Document Management System for Digital Archives (Scanned Documents)The elestio_papermerge resource allows the creation and management of Elestio Papermerge services. The service uses the following docker image elestio/papermerge https://hub.docker.com/r/elestio/papermerge
---

# elestio_papermerge (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Papermerge-zqmv.png" width="100" /><br>Open Source Document Management System for Digital Archives (Scanned Documents)<br><br>The **elestio_papermerge** resource allows the creation and management of Elestio Papermerge services. The service uses the following docker image [elestio/papermerge](https://hub.docker.com/r/elestio/papermerge)
...
```shell
# Import a Papermerge service by specifying the Project ID it belongs to, and the Papermerge service ID (spaced by a comma).
terraform import elestio_papermerge.my_papermerge project_id,papermerge_service_id
```
