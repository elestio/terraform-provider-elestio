...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Cassandra-npTG.png" width="100" height="100" /><br/> Cassandra is a resource that creates a service with the `template_id = 253`. Open Source NoSQL Database
