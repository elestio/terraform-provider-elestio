...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/budibase-logo-rW50.png" width="100" height="100" /><br/> Budibase is a resource that creates a service with the `template_id = 94`. Budibase is a quick way to build business apps that empower teams and improve productivity.
