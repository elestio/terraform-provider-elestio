...
```shell
# Import a Ollama service by specifying the Project ID it belongs to, and the Ollama service ID (spaced by a comma).
terraform import elestio_ollama.my_ollama project_id,ollama_service_id
```
