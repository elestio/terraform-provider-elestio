...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/typesense-1-OgKp.png" width="100" height="100" /><br/> Typesense is a resource that creates a service with the `template_id = 127`. Typesense is a fast, typo-tolerant, fuzzy search engine for building great search experiences.
