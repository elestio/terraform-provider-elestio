...
```shell
# Import a Glean service by specifying the Project ID it belongs to, and the Glean service ID (spaced by a comma).
terraform import elestio_glean.my_glean project_id,glean_service_id
```
