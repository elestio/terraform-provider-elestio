...
```shell
# Import a Sharkey service by specifying the Project ID it belongs to, and the Sharkey service ID (spaced by a comma).
terraform import elestio_sharkey.my_sharkey project_id,sharkey_service_id
```
