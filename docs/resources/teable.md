...
```shell
# Import a Teable service by specifying the Project ID it belongs to, and the Teable service ID (spaced by a comma).
terraform import elestio_teable.my_teable project_id,teable_service_id
```
