...
<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/jenkins-logo-fpDg.png" width="100" height="100" /><br/> Jenkins is a resource that creates a service with the `template_id = 114`. Jenkins is the leading open-source automation server.
