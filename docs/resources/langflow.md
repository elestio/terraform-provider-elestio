...
page_title: "elestio_langflow Resource - terraform-provider-elestio"
subcategory: "Services: AI/GPU"
description: |-
  Langflow is a visual framework for building multi-agent and RAG applications. It's open-source, Python-powered, fully customizable, and model and vector store agnostic.The elestio_langflow resource allows the creation and management of Elestio Langflow services. The service uses the following docker image langflowai/langflow https://hub.docker.com/r/langflowai/langflow
---

# elestio_langflow (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Langflow-eEG9.png" width="100" /><br>Langflow is a visual framework for building multi-agent and RAG applications. It's open-source, Python-powered, fully customizable, and model and vector store agnostic.<br><br>The **elestio_langflow** resource allows the creation and management of Elestio Langflow services. The service uses the following docker image [langflowai/langflow](https://hub.docker.com/r/langflowai/langflow)
...
- `version` (String) This is the version of the software used as service. **Default** `1.0.14`.
...
```shell
# Import a Langflow service by specifying the Project ID it belongs to, and the Langflow service ID (spaced by a comma).
terraform import elestio_langflow.my_langflow project_id,langflow_service_id
```
