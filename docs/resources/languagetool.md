...
subcategory: ""
description: |-
  LanguageTool is an Open Source proofreading software for English, Spanish, French, German, Portuguese, Polish, Dutch, and more than 20 other languages.elestio_languagetool is a preconfigured elestioservice resource (template_id: 286) running LanguageTool ([`dockerimage: erikvl87/languagetool`](https://hub.docker.com/r/erikvl87/languagetool)).
---

# elestio_languagetool (Resource)

<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/download-llvo.png" width="100" height="100" /><br/> LanguageTool is an Open Source proofreading software for English, Spanish, French, German, Portuguese, Polish, Dutch, and more than 20 other languages.<br/><br/>**elestio_languagetool** is a preconfigured elestio_service resource (`template_id: 286`) running **LanguageTool** ([`docker_image: erikvl87/languagetool`](https://hub.docker.com/r/erikvl87/languagetool)).
...
```shell
# Import a LanguageTool service by specifying the Project ID it belongs to, and the LanguageTool service ID (spaced by a comma).
terraform import elestio_languagetool.my_languagetool project_id,languagetool_service_id
```
