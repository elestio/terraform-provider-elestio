...
subcategory: ""
description: |-
  Browserless provides fast, scalable, reliable web browser automation. elestio_browserless is a preconfigured elestioservice resource (template_id: 77) running Browserless ([`dockerimage: browserless/chrome`](https://hub.docker.com/r/browserless/chrome)).
---
