...
subcategory: ""
description: |-
  Create your community based on Matrix protocolelestio_element is a preconfigured elestioservice resource (template_id: 248) running Element ([`dockerimage: matrixdotorg/synapse`](https://hub.docker.com/r/matrixdotorg/synapse)).
---

# elestio_element (Resource)

<img src="//cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Element-rC1j.png" width="100" height="100" /><br/> Create your community based on Matrix protocol<br/><br/>**elestio_element** is a preconfigured elestio_service resource (`template_id: 248`) running **Element** ([`docker_image: matrixdotorg/synapse`](https://hub.docker.com/r/matrixdotorg/synapse)).
