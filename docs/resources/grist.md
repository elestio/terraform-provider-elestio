...
page_title: "elestio_grist Resource - terraform-provider-elestio"
subcategory: "Services: Applications"
description: |-
  A modern, spreadsheet that goes beyond the grid.The elestio_grist resource allows the creation and management of Elestio Grist services. The service uses the following docker image gristlabs/grist-omnibus https://hub.docker.com/r/gristlabs/grist-omnibus
---

# elestio_grist (Resource)

<img src="https://cf.appdrag.com/dashboard-openvm-clo-b2d42c/uploads/Grist-kUaj.png" width="100" /><br>A modern, spreadsheet that goes beyond the grid.<br><br>The **elestio_grist** resource allows the creation and management of Elestio Grist services. The service uses the following docker image [gristlabs/grist-omnibus](https://hub.docker.com/r/gristlabs/grist-omnibus)
...
```shell
# Import a Grist service by specifying the Project ID it belongs to, and the Grist service ID (spaced by a comma).
terraform import elestio_grist.my_grist project_id,grist_service_id
```
