...
subcategory: ""
description: |-
  Neko-Rooms is a simple room management system for n.eko. elestionekorooms is a preconfigured elestioservice resource (template_id: 78) running Neko Rooms ([`dockerimage: m1k1o/neko-rooms`](https://hub.docker.com/r/m1k1o/neko-rooms)).
---
